...
const (
	...
	/* Request storage of different parameter values and logs. This command will be only accepted if in pre-flight mode. */
	MAV_CMD_PREFLIGHT_STORAGE_ADVANCED MavCmd = 0
)
...
type MavPreflightStorageAction uint32

const (
	/* Read all parameters from storage */
	MAV_PFS_CMD_READ_ALL MavPreflightStorageAction = 0

	/* Write all parameters to storage */
	MAV_PFS_CMD_WRITE_ALL MavPreflightStorageAction = 1

	/* Clear all  parameters in storage */
	MAV_PFS_CMD_CLEAR_ALL MavPreflightStorageAction = 2

	/* Read specific parameters from storage */
	MAV_PFS_CMD_READ_SPECIFIC MavPreflightStorageAction = 3

	/* Write specific parameters to storage */
	MAV_PFS_CMD_WRITE_SPECIFIC MavPreflightStorageAction = 4

	/* Clear specific parameters in storage */
	MAV_PFS_CMD_CLEAR_SPECIFIC MavPreflightStorageAction = 5

	/* do nothing */
	MAV_PFS_CMD_DO_NOTHING MavPreflightStorageAction = 6
)
