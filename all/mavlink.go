// Generated enums and structures for Mavlink dialect all #2 version 3
package all
...
const (
	...
	MAV_CMD_LOWEHEISER_SET_STATE MavCmd = 10151

	/* Set the distance to be repeated on mission resume */
	MAV_CMD_DO_SET_RESUME_REPEAT_DIST MavCmd = 215

	/* Control attached liquid sprayer */
	MAV_CMD_DO_SPRAYER MavCmd = 216

	/* Pass instructions onto scripting, a script should be checking for a new command */
	MAV_CMD_DO_SEND_SCRIPT_MESSAGE MavCmd = 217

	/* Execute auxiliary function */
	MAV_CMD_DO_AUX_FUNCTION MavCmd = 218
	...
	MAV_CMD_SET_EKF_SOURCE_SET MavCmd = 42007
	...
	MAV_CMD_RESET_MPPT MavCmd = 40001

	/* Mission command to perform a power cycle on payload */
	MAV_CMD_PAYLOAD_CONTROL MavCmd = 40002
	...
	MAV_CMD_DO_SET_SYS_CMP_ID MavCmd = 610
	...
	MAV_CMD_DO_SET_GLOBAL_ORIGIN MavCmd = 611
	...
	MAV_CMD_STORM32_DO_GIMBAL_MANAGER_CONTROL_PITCHYAW MavCmd = 60002
...
type AirlinkAuthResponseType uint32

const (
	/* Login or password error */
	AIRLINK_ERROR_LOGIN_OR_PASS AirlinkAuthResponseType = 0

	/* Auth successful */
	AIRLINK_AUTH_OK AirlinkAuthResponseType = 1
)

type PlaneMode uint32

const (
	/* HDGALT */
	PLANE_MODE_HDGALT PlaneMode = 27

	/* MANUAL */
	PLANE_MODE_MANUAL PlaneMode = 0

	/* CIRCLE */
	PLANE_MODE_CIRCLE PlaneMode = 1

	/* STABILIZE */
	PLANE_MODE_STABILIZE PlaneMode = 2

	/* TRAINING */
	PLANE_MODE_TRAINING PlaneMode = 3

	/* ACRO */
	PLANE_MODE_ACRO PlaneMode = 4

	/* FBWA */
	PLANE_MODE_FLY_BY_WIRE_A PlaneMode = 5

	/* FBWB */
	PLANE_MODE_FLY_BY_WIRE_B PlaneMode = 6

	/* CRUISE */
	PLANE_MODE_CRUISE PlaneMode = 7

	/* AUTOTUNE */
	PLANE_MODE_AUTOTUNE PlaneMode = 8

	/* AUTO */
	PLANE_MODE_AUTO PlaneMode = 10

	/* RTL */
	PLANE_MODE_RTL PlaneMode = 11

	/* LOITER */
	PLANE_MODE_LOITER PlaneMode = 12

	/* TAKEOFF */
	PLANE_MODE_TAKEOFF PlaneMode = 13

	/* AVOID ADSB */
	PLANE_MODE_AVOID_ADSB PlaneMode = 14

	/* GUIDED */
	PLANE_MODE_GUIDED PlaneMode = 15

	/* INITIALISING */
	PLANE_MODE_INITIALIZING PlaneMode = 16

	/* QSTABILIZE */
	PLANE_MODE_QSTABILIZE PlaneMode = 17

	/* QHOVER */
	PLANE_MODE_QHOVER PlaneMode = 18

	/* QLOITER */
	PLANE_MODE_QLOITER PlaneMode = 19
	...
	/* QACRO */
	PLANE_MODE_QACRO PlaneMode = 23

	/* THERMAL */
	PLANE_MODE_THERMAL PlaneMode = 24

	/* LOITER2QLAND */
	PLANE_MODE_LOITER_ALT_QLAND PlaneMode = 25

	/* AUTOLAND */
	PLANE_MODE_AUTOLAND PlaneMode = 26
)

/* Bitmask of which axes a HDGALT_COMMAND sets. A clear bit means the autopilot keeps its current value for that axis. */
type HdgaltCommandFlags uint32

const (
	/* Set if heading_deg is valid. */
	HDGALT_COMMAND_FLAG_HEADING HdgaltCommandFlags = 1

	/* Set if turn_rate_dps is valid. */
	HDGALT_COMMAND_FLAG_TURN_RATE HdgaltCommandFlags = 2

	/* Set if altitude_m is valid. */
	HDGALT_COMMAND_FLAG_ALTITUDE HdgaltCommandFlags = 4

	/* Set if climb_rate_mps is valid. */
	HDGALT_COMMAND_FLAG_CLIMB_RATE HdgaltCommandFlags = 8
)

/* Bitmask of which axes the HDGALT mode is actively controlling. */
type HdgaltStateFlags uint32

const (
	/* Set if heading is being actively controlled. */
	HDGALT_STATE_FLAG_HEADING_ACTIVE HdgaltStateFlags = 1

	/* Set if altitude is being actively controlled. */
	HDGALT_STATE_FLAG_ALTITUDE_ACTIVE HdgaltStateFlags = 2
)

/* Capture/hold phase reported by the HDGALT mode. */
type HdgaltCaptureState uint32

const (
	/* Both axes within deadband; holding. */
	HDGALT_CAPTURE_HOLD HdgaltCaptureState = 0

	/* Capturing heading; altitude held. */
	HDGALT_CAPTURE_LATERAL HdgaltCaptureState = 1

	/* Capturing altitude; heading held. */
	HDGALT_CAPTURE_VERTICAL HdgaltCaptureState = 2

	/* Capturing both heading and altitude. */
	HDGALT_CAPTURE_BOTH HdgaltCaptureState = 3
)

/* Warning bits reported in HDGALT_STATE. */
type HdgaltWarning uint32

const (
	/* Commanded altitude could not be reached; altitude target clipped to current, holding. */
	HDGALT_WARNING_CLIMB_UNACHIEVABLE HdgaltWarning = 1

	/* Commanded turn rate clipped by bank or stall-margin limit. */
	HDGALT_WARNING_TURN_DERATED HdgaltWarning = 2

	/* Airspeed approaching the minimum at which HDGALT disengages. */
	HDGALT_WARNING_AIRSPEED_LOW HdgaltWarning = 4
)

type AccelcalVehiclePos uint32

const (
	ACCELCAL_VEHICLE_POS_LEVEL AccelcalVehiclePos = 1

	ACCELCAL_VEHICLE_POS_LEFT AccelcalVehiclePos = 2

	ACCELCAL_VEHICLE_POS_RIGHT AccelcalVehiclePos = 3

	ACCELCAL_VEHICLE_POS_NOSEDOWN AccelcalVehiclePos = 4

	ACCELCAL_VEHICLE_POS_NOSEUP AccelcalVehiclePos = 5

	ACCELCAL_VEHICLE_POS_BACK AccelcalVehiclePos = 6
...
const (
	...
	SCRIPTING_CMD_REPL_START ScriptingCmd = 0

	/* End a REPL session. */
	SCRIPTING_CMD_REPL_STOP ScriptingCmd = 1

	/* Stop execution of scripts. */
	SCRIPTING_CMD_STOP ScriptingCmd = 2

	/* Stop execution of scripts and restart. */
	SCRIPTING_CMD_STOP_AND_RESTART ScriptingCmd = 3
)

type SecureCommandOp uint32
...
const (
	...
	SECURE_COMMAND_GET_SESSION_KEY SecureCommandOp = 0
	...
	SECURE_COMMAND_GET_REMOTEID_SESSION_KEY SecureCommandOp = 1
	...
	SECURE_COMMAND_REMOVE_PUBLIC_KEYS SecureCommandOp = 2
	...
	SECURE_COMMAND_GET_PUBLIC_KEYS SecureCommandOp = 3
	...
	SECURE_COMMAND_SET_PUBLIC_KEYS SecureCommandOp = 4
	...
	SECURE_COMMAND_GET_REMOTEID_CONFIG SecureCommandOp = 5
	...
	SECURE_COMMAND_SET_REMOTEID_CONFIG SecureCommandOp = 6
	...
	SECURE_COMMAND_FLASH_BOOTLOADER SecureCommandOp = 7
)
...
const (
	/* Pre-initialization. */
	LIMITS_INIT LimitsState = 0

	/* Disabled. */
	LIMITS_DISABLED LimitsState = 1

	/* Checking limits. */
	LIMITS_ENABLED LimitsState = 2

	/* A limit has been breached. */
	LIMITS_TRIGGERED LimitsState = 3

	/* Taking action e.g. Return/RTL. */
	LIMITS_RECOVERING LimitsState = 4

	/* We're no longer in breach of a limit. */
	LIMITS_RECOVERED LimitsState = 5
)

type LimitModule uint32

const (
	/* Pre-initialization. */
	LIMIT_GPSLOCK LimitModule = 1

	/* Disabled. */
	LIMIT_GEOFENCE LimitModule = 2

	/* Checking limits. */
	LIMIT_ALTITUDE LimitModule = 4
)

/* Flags in RALLY_POINT message. */
type RallyFlags uint32

const (
	/* Flag set when requiring favorable winds for landing. */
	FAVORABLE_WIND RallyFlags = 1
...
const (
	...
	MAV_MODE_GIMBAL_RATE_CMD_TIMEOUT MavModeGimbal = 6
)

type GimbalAxis uint32

const (
	/* Gimbal yaw axis. */
	GIMBAL_AXIS_YAW GimbalAxis = 0

	/* Gimbal pitch axis. */
	GIMBAL_AXIS_PITCH GimbalAxis = 1

	/* Gimbal roll axis. */
	GIMBAL_AXIS_ROLL GimbalAxis = 2
)

type GimbalAxisCalibrationStatus uint32

const (
	/* Axis calibration is in progress. */
	GIMBAL_AXIS_CALIBRATION_STATUS_IN_PROGRESS GimbalAxisCalibrationStatus = 0

	/* Axis calibration succeeded. */
	GIMBAL_AXIS_CALIBRATION_STATUS_SUCCEEDED GimbalAxisCalibrationStatus = 1

	/* Axis calibration failed. */
	GIMBAL_AXIS_CALIBRATION_STATUS_FAILED GimbalAxisCalibrationStatus = 2
)

type GimbalAxisCalibrationRequired uint32

const (
	/* Whether or not this axis requires calibration is unknown at this time. */
	GIMBAL_AXIS_CALIBRATION_REQUIRED_UNKNOWN GimbalAxisCalibrationRequired = 0

	/* This axis requires calibration. */
	GIMBAL_AXIS_CALIBRATION_REQUIRED_TRUE GimbalAxisCalibrationRequired = 1

	/* This axis does not require calibration. */
	GIMBAL_AXIS_CALIBRATION_REQUIRED_FALSE GimbalAxisCalibrationRequired = 2
)

type GoproHeartbeatStatus uint32

const (
	/* No GoPro connected. */
	GOPRO_HEARTBEAT_STATUS_DISCONNECTED GoproHeartbeatStatus = 0

	/* The detected GoPro is not HeroBus compatible. */
	GOPRO_HEARTBEAT_STATUS_INCOMPATIBLE GoproHeartbeatStatus = 1

	/* A HeroBus compatible GoPro is connected. */
	GOPRO_HEARTBEAT_STATUS_CONNECTED GoproHeartbeatStatus = 2

	/* An unrecoverable error was encountered with the connected GoPro, it may require a power cycle. */
	GOPRO_HEARTBEAT_STATUS_ERROR GoproHeartbeatStatus = 3
)

type GoproHeartbeatFlags uint32

const (
	/* GoPro is currently recording. */
	GOPRO_FLAG_RECORDING GoproHeartbeatFlags = 1
)

type GoproRequestStatus uint32

const (
	/* The write message with ID indicated succeeded. */
	GOPRO_REQUEST_SUCCESS GoproRequestStatus = 0

	/* The write message with ID indicated failed. */
	GOPRO_REQUEST_FAILED GoproRequestStatus = 1
)

type GoproCommand uint32

const (
	/* (Get/Set). */
	GOPRO_COMMAND_POWER GoproCommand = 0

	/* (Get/Set). */
	GOPRO_COMMAND_CAPTURE_MODE GoproCommand = 1

	/* (___/Set). */
	GOPRO_COMMAND_SHUTTER GoproCommand = 2

	/* (Get/___). */
	GOPRO_COMMAND_BATTERY GoproCommand = 3

	/* (Get/___). */
	GOPRO_COMMAND_MODEL GoproCommand = 4

	/* (Get/Set). */
	GOPRO_COMMAND_VIDEO_SETTINGS GoproCommand = 5

	/* (Get/Set). */
	GOPRO_COMMAND_LOW_LIGHT GoproCommand = 6

	/* (Get/Set). */
	GOPRO_COMMAND_PHOTO_RESOLUTION GoproCommand = 7

	/* (Get/Set). */
	GOPRO_COMMAND_PHOTO_BURST_RATE GoproCommand = 8

	/* (Get/Set). */
	GOPRO_COMMAND_PROTUNE GoproCommand = 9

	/* (Get/Set) Hero 3+ Only. */
	GOPRO_COMMAND_PROTUNE_WHITE_BALANCE GoproCommand = 10

	/* (Get/Set) Hero 3+ Only. */
	GOPRO_COMMAND_PROTUNE_COLOUR GoproCommand = 11

	/* (Get/Set) Hero 3+ Only. */
	GOPRO_COMMAND_PROTUNE_GAIN GoproCommand = 12

	/* (Get/Set) Hero 3+ Only. */
	GOPRO_COMMAND_PROTUNE_SHARPNESS GoproCommand = 13

	/* (Get/Set) Hero 3+ Only. */
	GOPRO_COMMAND_PROTUNE_EXPOSURE GoproCommand = 14

	/* (Get/Set). */
	GOPRO_COMMAND_TIME GoproCommand = 15

	/* (Get/Set). */
	GOPRO_COMMAND_CHARGING GoproCommand = 16
)

type GoproCaptureMode uint32

const (
	/* Video mode. */
	GOPRO_CAPTURE_MODE_VIDEO GoproCaptureMode = 0

	/* Photo mode. */
	GOPRO_CAPTURE_MODE_PHOTO GoproCaptureMode = 1

	/* Burst mode, Hero 3+ only. */
	GOPRO_CAPTURE_MODE_BURST GoproCaptureMode = 2

	/* Time lapse mode, Hero 3+ only. */
	GOPRO_CAPTURE_MODE_TIME_LAPSE GoproCaptureMode = 3

	/* Multi shot mode, Hero 4 only. */
	GOPRO_CAPTURE_MODE_MULTI_SHOT GoproCaptureMode = 4

	/* Playback mode, Hero 4 only, silver only except when LCD or HDMI is connected to black. */
	GOPRO_CAPTURE_MODE_PLAYBACK GoproCaptureMode = 5

	/* Playback mode, Hero 4 only. */
	GOPRO_CAPTURE_MODE_SETUP GoproCaptureMode = 6

	/* Mode not yet known. */
	GOPRO_CAPTURE_MODE_UNKNOWN GoproCaptureMode = 255
)

type GoproResolution uint32

const (
	/* 848 x 480 (480p). */
	GOPRO_RESOLUTION_480P GoproResolution = 0

	/* 1280 x 720 (720p). */
	GOPRO_RESOLUTION_720P GoproResolution = 1

	/* 1280 x 960 (960p). */
	GOPRO_RESOLUTION_960P GoproResolution = 2

	/* 1920 x 1080 (1080p). */
	GOPRO_RESOLUTION_1080P GoproResolution = 3

	/* 1920 x 1440 (1440p). */
	GOPRO_RESOLUTION_1440P GoproResolution = 4

	/* 2704 x 1440 (2.7k-17:9). */
	GOPRO_RESOLUTION_2_7K_17_9 GoproResolution = 5

	/* 2704 x 1524 (2.7k-16:9). */
	GOPRO_RESOLUTION_2_7K_16_9 GoproResolution = 6

	/* 2704 x 2028 (2.7k-4:3). */
	GOPRO_RESOLUTION_2_7K_4_3 GoproResolution = 7

	/* 3840 x 2160 (4k-16:9). */
	GOPRO_RESOLUTION_4K_16_9 GoproResolution = 8

	/* 4096 x 2160 (4k-17:9). */
	GOPRO_RESOLUTION_4K_17_9 GoproResolution = 9

	/* 1280 x 720 (720p-SuperView). */
	GOPRO_RESOLUTION_720P_SUPERVIEW GoproResolution = 10

	/* 1920 x 1080 (1080p-SuperView). */
	GOPRO_RESOLUTION_1080P_SUPERVIEW GoproResolution = 11

	/* 2704 x 1520 (2.7k-SuperView). */
	GOPRO_RESOLUTION_2_7K_SUPERVIEW GoproResolution = 12

	/* 3840 x 2160 (4k-SuperView). */
	GOPRO_RESOLUTION_4K_SUPERVIEW GoproResolution = 13
)

type GoproFrameRate uint32

const (
	/* 12 FPS. */
	GOPRO_FRAME_RATE_12 GoproFrameRate = 0

	/* 15 FPS. */
	GOPRO_FRAME_RATE_15 GoproFrameRate = 1

	/* 24 FPS. */
	GOPRO_FRAME_RATE_24 GoproFrameRate = 2

	/* 25 FPS. */
	GOPRO_FRAME_RATE_25 GoproFrameRate = 3

	/* 30 FPS. */
	GOPRO_FRAME_RATE_30 GoproFrameRate = 4

	/* 48 FPS. */
	GOPRO_FRAME_RATE_48 GoproFrameRate = 5

	/* 50 FPS. */
	GOPRO_FRAME_RATE_50 GoproFrameRate = 6

	/* 60 FPS. */
	GOPRO_FRAME_RATE_60 GoproFrameRate = 7

	/* 80 FPS. */
	GOPRO_FRAME_RATE_80 GoproFrameRate = 8

	/* 90 FPS. */
	GOPRO_FRAME_RATE_90 GoproFrameRate = 9

	/* 100 FPS. */
	GOPRO_FRAME_RATE_100 GoproFrameRate = 10

	/* 120 FPS. */
	GOPRO_FRAME_RATE_120 GoproFrameRate = 11

	/* 240 FPS. */
	GOPRO_FRAME_RATE_240 GoproFrameRate = 12

	/* 12.5 FPS. */
	GOPRO_FRAME_RATE_12_5 GoproFrameRate = 13
)

type GoproFieldOfView uint32

const (
	/* 0x00: Wide. */
	GOPRO_FIELD_OF_VIEW_WIDE GoproFieldOfView = 0

	/* 0x01: Medium. */
	GOPRO_FIELD_OF_VIEW_MEDIUM GoproFieldOfView = 1

	/* 0x02: Narrow. */
	GOPRO_FIELD_OF_VIEW_NARROW GoproFieldOfView = 2
)

type GoproVideoSettingsFlags uint32

const (
	/* 0=NTSC, 1=PAL. */
	GOPRO_VIDEO_SETTINGS_TV_MODE GoproVideoSettingsFlags = 1
)

type GoproPhotoResolution uint32

const (
	/* 5MP Medium. */
	GOPRO_PHOTO_RESOLUTION_5MP_MEDIUM GoproPhotoResolution = 0

	/* 7MP Medium. */
	GOPRO_PHOTO_RESOLUTION_7MP_MEDIUM GoproPhotoResolution = 1

	/* 7MP Wide. */
	GOPRO_PHOTO_RESOLUTION_7MP_WIDE GoproPhotoResolution = 2

	/* 10MP Wide. */
	GOPRO_PHOTO_RESOLUTION_10MP_WIDE GoproPhotoResolution = 3

	/* 12MP Wide. */
	GOPRO_PHOTO_RESOLUTION_12MP_WIDE GoproPhotoResolution = 4
)

type GoproProtuneWhiteBalance uint32

const (
	/* Auto. */
	GOPRO_PROTUNE_WHITE_BALANCE_AUTO GoproProtuneWhiteBalance = 0

	/* 3000K. */
	GOPRO_PROTUNE_WHITE_BALANCE_3000K GoproProtuneWhiteBalance = 1

	/* 5500K. */
	GOPRO_PROTUNE_WHITE_BALANCE_5500K GoproProtuneWhiteBalance = 2

	/* 6500K. */
	GOPRO_PROTUNE_WHITE_BALANCE_6500K GoproProtuneWhiteBalance = 3

	/* Camera Raw. */
	GOPRO_PROTUNE_WHITE_BALANCE_RAW GoproProtuneWhiteBalance = 4
)

type GoproProtuneColour uint32

const (
	/* Auto. */
	GOPRO_PROTUNE_COLOUR_STANDARD GoproProtuneColour = 0

	/* Neutral. */
	GOPRO_PROTUNE_COLOUR_NEUTRAL GoproProtuneColour = 1
)

type GoproProtuneGain uint32

const (
	/* ISO 400. */
	GOPRO_PROTUNE_GAIN_400 GoproProtuneGain = 0

	/* ISO 800 (Only Hero 4). */
	GOPRO_PROTUNE_GAIN_800 GoproProtuneGain = 1

	/* ISO 1600. */
	GOPRO_PROTUNE_GAIN_1600 GoproProtuneGain = 2

	/* ISO 3200 (Only Hero 4). */
	GOPRO_PROTUNE_GAIN_3200 GoproProtuneGain = 3

	/* ISO 6400. */
	GOPRO_PROTUNE_GAIN_6400 GoproProtuneGain = 4
)

type GoproProtuneSharpness uint32

const (
	/* Low Sharpness. */
	GOPRO_PROTUNE_SHARPNESS_LOW GoproProtuneSharpness = 0

	/* Medium Sharpness. */
	GOPRO_PROTUNE_SHARPNESS_MEDIUM GoproProtuneSharpness = 1

	/* High Sharpness. */
	GOPRO_PROTUNE_SHARPNESS_HIGH GoproProtuneSharpness = 2
)

type GoproProtuneExposure uint32

const (
	/* -5.0 EV (Hero 3+ Only). */
	GOPRO_PROTUNE_EXPOSURE_NEG_5_0 GoproProtuneExposure = 0

	/* -4.5 EV (Hero 3+ Only). */
	GOPRO_PROTUNE_EXPOSURE_NEG_4_5 GoproProtuneExposure = 1

	/* -4.0 EV (Hero 3+ Only). */
	GOPRO_PROTUNE_EXPOSURE_NEG_4_0 GoproProtuneExposure = 2

	/* -3.5 EV (Hero 3+ Only). */
	GOPRO_PROTUNE_EXPOSURE_NEG_3_5 GoproProtuneExposure = 3

	/* -3.0 EV (Hero 3+ Only). */
	GOPRO_PROTUNE_EXPOSURE_NEG_3_0 GoproProtuneExposure = 4

	/* -2.5 EV (Hero 3+ Only). */
	GOPRO_PROTUNE_EXPOSURE_NEG_2_5 GoproProtuneExposure = 5

	/* -2.0 EV. */
	GOPRO_PROTUNE_EXPOSURE_NEG_2_0 GoproProtuneExposure = 6

	/* -1.5 EV. */
	GOPRO_PROTUNE_EXPOSURE_NEG_1_5 GoproProtuneExposure = 7

	/* -1.0 EV. */
	GOPRO_PROTUNE_EXPOSURE_NEG_1_0 GoproProtuneExposure = 8

	/* -0.5 EV. */
	GOPRO_PROTUNE_EXPOSURE_NEG_0_5 GoproProtuneExposure = 9

	/* 0.0 EV. */
	GOPRO_PROTUNE_EXPOSURE_ZERO GoproProtuneExposure = 10

	/* +0.5 EV. */
	GOPRO_PROTUNE_EXPOSURE_POS_0_5 GoproProtuneExposure = 11

	/* +1.0 EV. */
	GOPRO_PROTUNE_EXPOSURE_POS_1_0 GoproProtuneExposure = 12

	/* +1.5 EV. */
	GOPRO_PROTUNE_EXPOSURE_POS_1_5 GoproProtuneExposure = 13

	/* +2.0 EV. */
	GOPRO_PROTUNE_EXPOSURE_POS_2_0 GoproProtuneExposure = 14

	/* +2.5 EV (Hero 3+ Only). */
	GOPRO_PROTUNE_EXPOSURE_POS_2_5 GoproProtuneExposure = 15

	/* +3.0 EV (Hero 3+ Only). */
	GOPRO_PROTUNE_EXPOSURE_POS_3_0 GoproProtuneExposure = 16

	/* +3.5 EV (Hero 3+ Only). */
	GOPRO_PROTUNE_EXPOSURE_POS_3_5 GoproProtuneExposure = 17

	/* +4.0 EV (Hero 3+ Only). */
	GOPRO_PROTUNE_EXPOSURE_POS_4_0 GoproProtuneExposure = 18

	/* +4.5 EV (Hero 3+ Only). */
	GOPRO_PROTUNE_EXPOSURE_POS_4_5 GoproProtuneExposure = 19

	/* +5.0 EV (Hero 3+ Only). */
	GOPRO_PROTUNE_EXPOSURE_POS_5_0 GoproProtuneExposure = 20
)

type GoproCharging uint32

const (
	/* Charging disabled. */
	GOPRO_CHARGING_DISABLED GoproCharging = 0

	/* Charging enabled. */
	GOPRO_CHARGING_ENABLED GoproCharging = 1
)

type GoproModel uint32

const (
	/* Unknown gopro model. */
	GOPRO_MODEL_UNKNOWN GoproModel = 0

	/* Hero 3+ Silver (HeroBus not supported by GoPro). */
	GOPRO_MODEL_HERO_3_PLUS_SILVER GoproModel = 1

	/* Hero 3+ Black. */
	GOPRO_MODEL_HERO_3_PLUS_BLACK GoproModel = 2

	/* Hero 4 Silver. */
	GOPRO_MODEL_HERO_4_SILVER GoproModel = 3

	/* Hero 4 Black. */
	GOPRO_MODEL_HERO_4_BLACK GoproModel = 4
)

type GoproBurstRate uint32

const (
	/* 3 Shots / 1 Second. */
	GOPRO_BURST_RATE_3_IN_1_SECOND GoproBurstRate = 0

	/* 5 Shots / 1 Second. */
	GOPRO_BURST_RATE_5_IN_1_SECOND GoproBurstRate = 1

	/* 10 Shots / 1 Second. */
	GOPRO_BURST_RATE_10_IN_1_SECOND GoproBurstRate = 2

	/* 10 Shots / 2 Second. */
	GOPRO_BURST_RATE_10_IN_2_SECOND GoproBurstRate = 3

	/* 10 Shots / 3 Second (Hero 4 Only). */
	GOPRO_BURST_RATE_10_IN_3_SECOND GoproBurstRate = 4

	/* 30 Shots / 1 Second. */
	GOPRO_BURST_RATE_30_IN_1_SECOND GoproBurstRate = 5

	/* 30 Shots / 2 Second. */
	GOPRO_BURST_RATE_30_IN_2_SECOND GoproBurstRate = 6

	/* 30 Shots / 3 Second. */
	GOPRO_BURST_RATE_30_IN_3_SECOND GoproBurstRate = 7

	/* 30 Shots / 6 Second. */
	GOPRO_BURST_RATE_30_IN_6_SECOND GoproBurstRate = 8
)

type MavCmdDoAuxFunctionSwitchLevel uint32

const (
	/* Switch Low. */
	MAV_CMD_DO_AUX_FUNCTION_SWITCH_LEVEL_LOW MavCmdDoAuxFunctionSwitchLevel = 0

	/* Switch Middle. */
	MAV_CMD_DO_AUX_FUNCTION_SWITCH_LEVEL_MIDDLE MavCmdDoAuxFunctionSwitchLevel = 1

	/* Switch High. */
	MAV_CMD_DO_AUX_FUNCTION_SWITCH_LEVEL_HIGH MavCmdDoAuxFunctionSwitchLevel = 2
)

type LedControlPattern uint32

const (
	/* LED patterns off (return control to regular vehicle control). */
	LED_CONTROL_PATTERN_OFF LedControlPattern = 0

	/* LEDs show pattern during firmware update. */
	LED_CONTROL_PATTERN_FIRMWAREUPDATE LedControlPattern = 1

	/* Custom Pattern using custom bytes fields. */
	LED_CONTROL_PATTERN_CUSTOM LedControlPattern = 255
)

/* Flags in EKF_STATUS message. */
type EkfStatusFlags uint32

const (
	/* Set if EKF's attitude estimate is good. */
	EKF_ATTITUDE EkfStatusFlags = 1

	/* Set if EKF's horizontal velocity estimate is good. */
	EKF_VELOCITY_HORIZ EkfStatusFlags = 2

	/* Set if EKF's vertical velocity estimate is good. */
	EKF_VELOCITY_VERT EkfStatusFlags = 4

	/* Set if EKF's horizontal position (relative) estimate is good. */
	EKF_POS_HORIZ_REL EkfStatusFlags = 8

	/* Set if EKF's horizontal position (absolute) estimate is good. */
	EKF_POS_HORIZ_ABS EkfStatusFlags = 16

	/* Set if EKF's vertical position (absolute) estimate is good. */
	EKF_POS_VERT_ABS EkfStatusFlags = 32

	/* Set if EKF's vertical position (above ground) estimate is good. */
	EKF_POS_VERT_AGL EkfStatusFlags = 64

	/* EKF is in constant position mode and does not know it's absolute or relative position. */
	EKF_CONST_POS_MODE EkfStatusFlags = 128

	/* Set if EKF's predicted horizontal position (relative) estimate is good. */
	EKF_PRED_POS_HORIZ_REL EkfStatusFlags = 256

	/* Set if EKF's predicted horizontal position (absolute) estimate is good. */
	EKF_PRED_POS_HORIZ_ABS EkfStatusFlags = 512

	/* Set if EKF believes the GPS input data is faulty. */
	EKF_GPS_GLITCHING EkfStatusFlags = 32768

	/* Set if EKF has never been healthy. */
	EKF_UNINITIALIZED EkfStatusFlags = 1024
)

type PidTuningAxis uint32

const (
	PID_TUNING_ROLL PidTuningAxis = 1

	PID_TUNING_PITCH PidTuningAxis = 2

	PID_TUNING_YAW PidTuningAxis = 3

	PID_TUNING_ACCZ PidTuningAxis = 4

	PID_TUNING_STEER PidTuningAxis = 5

	PID_TUNING_LANDING PidTuningAxis = 6

	/* Left wheel rate. */
	PID_TUNING_WHEEL_LEFT PidTuningAxis = 7

	/* Right wheel rate. */
	PID_TUNING_WHEEL_RIGHT PidTuningAxis = 8

	/* Sailboat heel to mainsail. */
	PID_TUNING_SAIL_HEEL PidTuningAxis = 9

	/* Velocity north. */
	PID_TUNING_VEL_NORTH PidTuningAxis = 10

	/* Velocity east. */
	PID_TUNING_VEL_EAST PidTuningAxis = 11

	/* Velocity down. */
	PID_TUNING_VEL_DOWN PidTuningAxis = 12

	/* Position north. */
	PID_TUNING_POS_NORTH PidTuningAxis = 13

	/* Position east. */
	PID_TUNING_POS_EAST PidTuningAxis = 14

	/* Position down. */
	PID_TUNING_POS_DOWN PidTuningAxis = 15

	/* Yaw angle. */
	PID_TUNING_YAW_ANGLE PidTuningAxis = 16
)

/* Special ACK block numbers control activation of dataflash log streaming. */
type MavRemoteLogDataBlockCommands uint32

const (
	/* UAV to stop sending DataFlash blocks. */
	MAV_REMOTE_LOG_DATA_BLOCK_STOP MavRemoteLogDataBlockCommands = 2147483645

	/* UAV to start sending DataFlash blocks. */
	MAV_REMOTE_LOG_DATA_BLOCK_START MavRemoteLogDataBlockCommands = 2147483646
)

/* Possible remote log data block statuses. */
type MavRemoteLogDataBlockStatuses uint32

const (
	/* This block has NOT been received. */
	MAV_REMOTE_LOG_DATA_BLOCK_NACK MavRemoteLogDataBlockStatuses = 0

	/* This block has been received. */
	MAV_REMOTE_LOG_DATA_BLOCK_ACK MavRemoteLogDataBlockStatuses = 1
)

/* Bus types for device operations. */
type DeviceOpBustype uint32

const (
	/* I2C Device operation. */
	DEVICE_OP_BUSTYPE_I2C DeviceOpBustype = 0

	/* SPI Device operation. */
	DEVICE_OP_BUSTYPE_SPI DeviceOpBustype = 1
)

/* Deepstall flight stage. */
type DeepstallStage uint32

const (
	/* Flying to the landing point. */
	DEEPSTALL_STAGE_FLY_TO_LANDING DeepstallStage = 0

	/* Building an estimate of the wind. */
	DEEPSTALL_STAGE_ESTIMATE_WIND DeepstallStage = 1

	/* Waiting to breakout of the loiter to fly the approach. */
	DEEPSTALL_STAGE_WAIT_FOR_BREAKOUT DeepstallStage = 2

	/* Flying to the first arc point to turn around to the landing point. */
	DEEPSTALL_STAGE_FLY_TO_ARC DeepstallStage = 3

	/* Turning around back to the deepstall landing point. */
	DEEPSTALL_STAGE_ARC DeepstallStage = 4

	/* Approaching the landing point. */
	DEEPSTALL_STAGE_APPROACH DeepstallStage = 5

	/* Stalling and steering towards the land point. */
	DEEPSTALL_STAGE_LAND DeepstallStage = 6
)

/* A mapping of copter flight modes for custom_mode field of heartbeat. */
type CopterMode uint32

const (
	/* STABILIZE */
	COPTER_MODE_STABILIZE CopterMode = 0

	/* ACRO */
	COPTER_MODE_ACRO CopterMode = 1

	/* ALT HOLD */
	COPTER_MODE_ALT_HOLD CopterMode = 2

	/* AUTO */
	COPTER_MODE_AUTO CopterMode = 3

	/* GUIDED */
	COPTER_MODE_GUIDED CopterMode = 4

	/* LOITER */
	COPTER_MODE_LOITER CopterMode = 5

	/* RTL */
	COPTER_MODE_RTL CopterMode = 6

	/* CIRCLE */
	COPTER_MODE_CIRCLE CopterMode = 7

	/* LAND */
	COPTER_MODE_LAND CopterMode = 9

	/* DRIFT */
	COPTER_MODE_DRIFT CopterMode = 11

	/* SPORT */
	COPTER_MODE_SPORT CopterMode = 13

	/* FLIP */
	COPTER_MODE_FLIP CopterMode = 14

	/* AUTOTUNE */
	COPTER_MODE_AUTOTUNE CopterMode = 15

	/* POSHOLD */
	COPTER_MODE_POSHOLD CopterMode = 16

	/* BRAKE */
	COPTER_MODE_BRAKE CopterMode = 17

	/* THROW */
	COPTER_MODE_THROW CopterMode = 18

	/* AVOID ADSB */
	COPTER_MODE_AVOID_ADSB CopterMode = 19

	/* GUIDED NOGPS */
	COPTER_MODE_GUIDED_NOGPS CopterMode = 20

	/* SMARTRTL */
	COPTER_MODE_SMART_RTL CopterMode = 21

	/* FLOWHOLD */
	COPTER_MODE_FLOWHOLD CopterMode = 22

	/* FOLLOW */
	COPTER_MODE_FOLLOW CopterMode = 23

	/* ZIGZAG */
	COPTER_MODE_ZIGZAG CopterMode = 24

	/* SYSTEMID */
	COPTER_MODE_SYSTEMID CopterMode = 25

	/* AUTOROTATE */
	COPTER_MODE_AUTOROTATE CopterMode = 26

	/* AUTO RTL */
	COPTER_MODE_AUTO_RTL CopterMode = 27

	/* TURTLE */
	COPTER_MODE_TURTLE CopterMode = 28

	/* RATE_ACRO */
	COPTER_MODE_RATE_ACRO CopterMode = 29
)
...
const (
	/* STABILIZE */
	SUB_MODE_STABILIZE SubMode = 0

	/* ACRO */
	SUB_MODE_ACRO SubMode = 1

	/* ALT HOLD */
	SUB_MODE_ALT_HOLD SubMode = 2

	/* AUTO */
	SUB_MODE_AUTO SubMode = 3

	/* GUIDED */
	SUB_MODE_GUIDED SubMode = 4

	/* CIRCLE */
	SUB_MODE_CIRCLE SubMode = 7

	/* SURFACE */
	SUB_MODE_SURFACE SubMode = 9

	/* POSHOLD */
	SUB_MODE_POSHOLD SubMode = 16

	/* MANUAL */
	SUB_MODE_MANUAL SubMode = 19

	/* MOTORDETECT */
	SUB_MODE_MOTORDETECT SubMode = 20

	/* SURFTRAK */
	SUB_MODE_SURFTRAK SubMode = 21
)

/* A mapping of rover flight modes for custom_mode field of heartbeat. */
type RoverMode uint32

const (
	/* MANUAL */
	ROVER_MODE_MANUAL RoverMode = 0

	/* ACRO */
	ROVER_MODE_ACRO RoverMode = 1

	/* STEERING */
	ROVER_MODE_STEERING RoverMode = 3

	/* HOLD */
	ROVER_MODE_HOLD RoverMode = 4

	/* LOITER */
	ROVER_MODE_LOITER RoverMode = 5

	/* FOLLOW */
	ROVER_MODE_FOLLOW RoverMode = 6

	/* SIMPLE */
	ROVER_MODE_SIMPLE RoverMode = 7

	/* DOCK */
	ROVER_MODE_DOCK RoverMode = 8

	/* CIRCLE */
	ROVER_MODE_CIRCLE RoverMode = 9

	/* AUTO */
	ROVER_MODE_AUTO RoverMode = 10

	/* RTL */
	ROVER_MODE_RTL RoverMode = 11

	/* SMART RTL */
	ROVER_MODE_SMART_RTL RoverMode = 12

	/* GUIDED */
	ROVER_MODE_GUIDED RoverMode = 15

	/* INITIALISING */
	ROVER_MODE_INITIALIZING RoverMode = 16
)

/* A mapping of antenna tracker flight modes for custom_mode field of heartbeat. */
type TrackerMode uint32

const (
	/* MANUAL */
	TRACKER_MODE_MANUAL TrackerMode = 0

	/* STOP */
	TRACKER_MODE_STOP TrackerMode = 1

	/* SCAN */
	TRACKER_MODE_SCAN TrackerMode = 2

	/* SERVO TEST */
	TRACKER_MODE_SERVO_TEST TrackerMode = 3

	/* GUIDED */
	TRACKER_MODE_GUIDED TrackerMode = 4

	/* AUTO */
	TRACKER_MODE_AUTO TrackerMode = 10

	/* INITIALISING */
	TRACKER_MODE_INITIALIZING TrackerMode = 16
)

/* The type of parameter for the OSD parameter editor. */
type OsdParamConfigType uint32

const (
	OSD_PARAM_NONE OsdParamConfigType = 0

	OSD_PARAM_SERIAL_PROTOCOL OsdParamConfigType = 1

	OSD_PARAM_SERVO_FUNCTION OsdParamConfigType = 2

	OSD_PARAM_AUX_FUNCTION OsdParamConfigType = 3

	OSD_PARAM_FLIGHT_MODE OsdParamConfigType = 4

	OSD_PARAM_FAILSAFE_ACTION OsdParamConfigType = 5

	OSD_PARAM_FAILSAFE_ACTION_1 OsdParamConfigType = 6

	OSD_PARAM_FAILSAFE_ACTION_2 OsdParamConfigType = 7

	OSD_PARAM_NUM_TYPES OsdParamConfigType = 8
)

/* The error type for the OSD parameter editor. */
type OsdParamConfigError uint32

const (
	OSD_PARAM_SUCCESS OsdParamConfigError = 0

	OSD_PARAM_INVALID_SCREEN OsdParamConfigError = 1

	OSD_PARAM_INVALID_PARAMETER_INDEX OsdParamConfigError = 2

	OSD_PARAM_INVALID_PARAMETER OsdParamConfigError = 3
)

type GsmLinkType uint32

const (
	/* no service */
	GSM_LINK_TYPE_NONE GsmLinkType = 0

	/* link type unknown */
	GSM_LINK_TYPE_UNKNOWN GsmLinkType = 1

	/* 2G (GSM/GRPS/EDGE) link */
	GSM_LINK_TYPE_2G GsmLinkType = 2

	/* 3G link (WCDMA/HSDPA/HSPA)  */
	GSM_LINK_TYPE_3G GsmLinkType = 3

	/* 4G link (LTE) */
	GSM_LINK_TYPE_4G GsmLinkType = 4
)

type GsmModemType uint32

const (
	/* not specified */
	GSM_MODEM_TYPE_UNKNOWN GsmModemType = 0

	/* HUAWEI LTE USB Stick E3372 */
	GSM_MODEM_TYPE_HUAWEI_E3372 GsmModemType = 1
)

/* RADIO_RC_CHANNELS flags (bitmask). */
type RadioRcChannelsFlags uint32

const (
	/* Failsafe is active. The content of the RC channels data in the RADIO_RC_CHANNELS message is implementation dependent. */
	RADIO_RC_CHANNELS_FLAGS_FAILSAFE RadioRcChannelsFlags = 1
	...
	RADIO_RC_CHANNELS_FLAGS_OUTDATED RadioRcChannelsFlags = 2
)
...
type GpsSystemErrorFlags uint32

const (
	/* There are problems with incoming correction streams. */
	GPS_SYSTEM_ERROR_INCOMING_CORRECTIONS GpsSystemErrorFlags = 1

	/* There are problems with the configuration. */
	GPS_SYSTEM_ERROR_CONFIGURATION GpsSystemErrorFlags = 2

	/* There are problems with the software on the GPS receiver. */
	GPS_SYSTEM_ERROR_SOFTWARE GpsSystemErrorFlags = 4

	/* There are problems with an antenna connected to the GPS receiver. */
	GPS_SYSTEM_ERROR_ANTENNA GpsSystemErrorFlags = 8

	/* There are problems handling all incoming events. */
	GPS_SYSTEM_ERROR_EVENT_CONGESTION GpsSystemErrorFlags = 16

	/* The GPS receiver CPU is overloaded. */
	GPS_SYSTEM_ERROR_CPU_OVERLOAD GpsSystemErrorFlags = 32

	/* The GPS receiver is experiencing output congestion. */
	GPS_SYSTEM_ERROR_OUTPUT_CONGESTION GpsSystemErrorFlags = 64
)

/* Signal authentication state in a GPS receiver. */
type GpsAuthenticationState uint32

const (
	/* The GPS receiver does not provide GPS signal authentication info. */
	GPS_AUTHENTICATION_STATE_UNKNOWN GpsAuthenticationState = 0

	/* The GPS receiver is initializing signal authentication. */
	GPS_AUTHENTICATION_STATE_INITIALIZING GpsAuthenticationState = 1

	/* The GPS receiver encountered an error while initializing signal authentication. */
	GPS_AUTHENTICATION_STATE_ERROR GpsAuthenticationState = 2

	/* The GPS receiver has correctly authenticated all signals. */
	GPS_AUTHENTICATION_STATE_OK GpsAuthenticationState = 3

	/* GPS signal authentication is disabled on the receiver. */
	GPS_AUTHENTICATION_STATE_DISABLED GpsAuthenticationState = 4
)

/* Signal jamming state in a GPS receiver. */
type GpsJammingState uint32

const (
	/* The GPS receiver does not provide GPS signal jamming info. */
	GPS_JAMMING_STATE_UNKNOWN GpsJammingState = 0

	/* The GPS receiver detected no signal jamming. */
	GPS_JAMMING_STATE_NOT_JAMMED GpsJammingState = 1

	/* The GPS receiver detected and mitigated signal jamming. */
	GPS_JAMMING_STATE_MITIGATED GpsJammingState = 2

	/* The GPS receiver detected signal jamming. */
	GPS_JAMMING_STATE_DETECTED GpsJammingState = 3
)

/* Signal spoofing state in a GPS receiver. */
type GpsSpoofingState uint32

const (
	/* The GPS receiver does not provide GPS signal spoofing info. */
	GPS_SPOOFING_STATE_UNKNOWN GpsSpoofingState = 0

	/* The GPS receiver detected no signal spoofing. */
	GPS_SPOOFING_STATE_NOT_SPOOFED GpsSpoofingState = 1

	/* The GPS receiver detected and mitigated signal spoofing. */
	GPS_SPOOFING_STATE_MITIGATED GpsSpoofingState = 2

	/* The GPS receiver detected signal spoofing but still has a fix. */
	GPS_SPOOFING_STATE_DETECTED GpsSpoofingState = 3
)

/* State of RAIM processing. */
type GpsRaimState uint32

const (
	/* RAIM capability is unknown. */
	GPS_RAIM_STATE_UNKNOWN GpsRaimState = 0

	/* RAIM is disabled. */
	GPS_RAIM_STATE_DISABLED GpsRaimState = 1

	/* RAIM integrity check was successful. */
	GPS_RAIM_STATE_OK GpsRaimState = 2

	/* RAIM integrity check failed. */
	GPS_RAIM_STATE_FAILED GpsRaimState = 3
)

/* Available autopilot modes for ualberta uav */
type UalbertaAutopilotMode uint32

const (
	/* Raw input pulse widts sent to output */
	MODE_MANUAL_DIRECT UalbertaAutopilotMode = 1

	/* Inputs are normalized using calibration, the converted back to raw pulse widths for output */
	MODE_MANUAL_SCALED UalbertaAutopilotMode = 2

	/*  dfsdfs */
	MODE_AUTO_PID_ATT UalbertaAutopilotMode = 3

	/*  dfsfds */
	MODE_AUTO_PID_VEL UalbertaAutopilotMode = 4

	/*  dfsdfsdfs */
	MODE_AUTO_PID_POS UalbertaAutopilotMode = 5
)

/* Navigation filter mode */
type UalbertaNavMode uint32

const (
	NAV_AHRS_INIT UalbertaNavMode = 1

	/* AHRS mode */
	NAV_AHRS UalbertaNavMode = 2

	/* INS/GPS initialization mode */
	NAV_INS_GPS_INIT UalbertaNavMode = 3

	/* INS/GPS mode */
	NAV_INS_GPS UalbertaNavMode = 4
)

/* Mode currently commanded by pilot */
type UalbertaPilotMode uint32

const (
	/*  sdf */
	PILOT_MANUAL UalbertaPilotMode = 1

	/*  dfs */
	PILOT_AUTO UalbertaPilotMode = 2

	/*  Rotomotion mode  */
	PILOT_ROTO UalbertaPilotMode = 3
)

type MavStorm32TunnelPayloadType uint32

const (
	/* Registered for STorM32 gimbal controller. For communication with gimbal or camera. */
	MAV_STORM32_TUNNEL_PAYLOAD_TYPE_STORM32_CH1_IN MavStorm32TunnelPayloadType = 200

	/* Registered for STorM32 gimbal controller. For communication with gimbal or camera. */
	MAV_STORM32_TUNNEL_PAYLOAD_TYPE_STORM32_CH1_OUT MavStorm32TunnelPayloadType = 201

	/* Registered for STorM32 gimbal controller. For communication with gimbal. */
	MAV_STORM32_TUNNEL_PAYLOAD_TYPE_STORM32_CH2_IN MavStorm32TunnelPayloadType = 202

	/* Registered for STorM32 gimbal controller. For communication with gimbal. */
	MAV_STORM32_TUNNEL_PAYLOAD_TYPE_STORM32_CH2_OUT MavStorm32TunnelPayloadType = 203

	/* Registered for STorM32 gimbal controller. For communication with camera. */
	MAV_STORM32_TUNNEL_PAYLOAD_TYPE_STORM32_CH3_IN MavStorm32TunnelPayloadType = 204

	/* Registered for STorM32 gimbal controller. For communication with camera. */
	MAV_STORM32_TUNNEL_PAYLOAD_TYPE_STORM32_CH3_OUT MavStorm32TunnelPayloadType = 205
)

/* Gimbal manager capability flags. */
type MavStorm32GimbalManagerCapFlags uint32

const (
	/* The gimbal manager supports several profiles. */
	MAV_STORM32_GIMBAL_MANAGER_CAP_FLAGS_HAS_PROFILES MavStorm32GimbalManagerCapFlags = 1
)
...
type MavStorm32GimbalManagerFlags uint32
...
const (
	...
	MAV_STORM32_GIMBAL_MANAGER_FLAGS_RC_ACTIVE MavStorm32GimbalManagerFlags = 1

	/* Request to set onboard/companion computer client to active, or report this client is active. */
	MAV_STORM32_GIMBAL_MANAGER_FLAGS_CLIENT_ONBOARD_ACTIVE MavStorm32GimbalManagerFlags = 2

	/* Request to set autopliot client to active, or report this client is active. */
	MAV_STORM32_GIMBAL_MANAGER_FLAGS_CLIENT_AUTOPILOT_ACTIVE MavStorm32GimbalManagerFlags = 4

	/* Request to set GCS client to active, or report this client is active. */
	MAV_STORM32_GIMBAL_MANAGER_FLAGS_CLIENT_GCS_ACTIVE MavStorm32GimbalManagerFlags = 8

	/* Request to set camera client to active, or report this client is active. */
	MAV_STORM32_GIMBAL_MANAGER_FLAGS_CLIENT_CAMERA_ACTIVE MavStorm32GimbalManagerFlags = 16

	/* Request to set GCS2 client to active, or report this client is active. */
	MAV_STORM32_GIMBAL_MANAGER_FLAGS_CLIENT_GCS2_ACTIVE MavStorm32GimbalManagerFlags = 32

	/* Request to set camera2 client to active, or report this client is active. */
	MAV_STORM32_GIMBAL_MANAGER_FLAGS_CLIENT_CAMERA2_ACTIVE MavStorm32GimbalManagerFlags = 64

	/* Request to set custom client to active, or report this client is active. */
	MAV_STORM32_GIMBAL_MANAGER_FLAGS_CLIENT_CUSTOM_ACTIVE MavStorm32GimbalManagerFlags = 128

	/* Request to set custom2 client to active, or report this client is active. */
	MAV_STORM32_GIMBAL_MANAGER_FLAGS_CLIENT_CUSTOM2_ACTIVE MavStorm32GimbalManagerFlags = 256

	/* Request supervision. This flag is only for setting, it is not reported. */
	MAV_STORM32_GIMBAL_MANAGER_FLAGS_SET_SUPERVISON MavStorm32GimbalManagerFlags = 512

	/* Release supervision. This flag is only for setting, it is not reported. */
	MAV_STORM32_GIMBAL_MANAGER_FLAGS_SET_RELEASE MavStorm32GimbalManagerFlags = 1024
)
...
type MavStorm32GimbalManagerClient uint32

const (
	/* For convenience. */
	MAV_STORM32_GIMBAL_MANAGER_CLIENT_NONE MavStorm32GimbalManagerClient = 0

	/* This is the onboard/companion computer client. */
	MAV_STORM32_GIMBAL_MANAGER_CLIENT_ONBOARD MavStorm32GimbalManagerClient = 1

	/* This is the autopilot client. */
	MAV_STORM32_GIMBAL_MANAGER_CLIENT_AUTOPILOT MavStorm32GimbalManagerClient = 2

	/* This is the GCS client. */
	MAV_STORM32_GIMBAL_MANAGER_CLIENT_GCS MavStorm32GimbalManagerClient = 3

	/* This is the camera client. */
	MAV_STORM32_GIMBAL_MANAGER_CLIENT_CAMERA MavStorm32GimbalManagerClient = 4

	/* This is the GCS2 client. */
	MAV_STORM32_GIMBAL_MANAGER_CLIENT_GCS2 MavStorm32GimbalManagerClient = 5

	/* This is the camera2 client. */
	MAV_STORM32_GIMBAL_MANAGER_CLIENT_CAMERA2 MavStorm32GimbalManagerClient = 6

	/* This is the custom client. */
	MAV_STORM32_GIMBAL_MANAGER_CLIENT_CUSTOM MavStorm32GimbalManagerClient = 7

	/* This is the custom2 client. */
	MAV_STORM32_GIMBAL_MANAGER_CLIENT_CUSTOM2 MavStorm32GimbalManagerClient = 8
)
...
type MavStorm32GimbalManagerProfile uint32

const (
	/* Default profile. Implementation specific. */
	MAV_STORM32_GIMBAL_MANAGER_PROFILE_DEFAULT MavStorm32GimbalManagerProfile = 0

	/* Not supported/deprecated. */
	MAV_STORM32_GIMBAL_MANAGER_PROFILE_CUSTOM MavStorm32GimbalManagerProfile = 1

	/* Profile with cooperative behavior. */
	MAV_STORM32_GIMBAL_MANAGER_PROFILE_COOPERATIVE MavStorm32GimbalManagerProfile = 2

	/* Profile with exclusive behavior. */
	MAV_STORM32_GIMBAL_MANAGER_PROFILE_EXCLUSIVE MavStorm32GimbalManagerProfile = 3

	/* Profile with priority and cooperative behavior for equal priority. */
	MAV_STORM32_GIMBAL_MANAGER_PROFILE_PRIORITY_COOPERATIVE MavStorm32GimbalManagerProfile = 4

	/* Profile with priority and exclusive behavior for equal priority. */
	MAV_STORM32_GIMBAL_MANAGER_PROFILE_PRIORITY_EXCLUSIVE MavStorm32GimbalManagerProfile = 5
)

/* Enumeration of possible shot modes. */
type MavQshotMode uint32

const (
	/* Undefined shot mode. Can be used to determine if qshots should be used or not. */
	MAV_QSHOT_MODE_UNDEFINED MavQshotMode = 0

	/* Start normal gimbal operation. Is usually used to return back from a shot. */
	MAV_QSHOT_MODE_DEFAULT MavQshotMode = 1

	/* Load and keep safe gimbal position and stop stabilization. */
	MAV_QSHOT_MODE_GIMBAL_RETRACT MavQshotMode = 2

	/* Load neutral gimbal position and keep it while stabilizing. */
	MAV_QSHOT_MODE_GIMBAL_NEUTRAL MavQshotMode = 3

	/* Start mission with gimbal control. */
	MAV_QSHOT_MODE_GIMBAL_MISSION MavQshotMode = 4

	/* Start RC gimbal control. */
	MAV_QSHOT_MODE_GIMBAL_RC_CONTROL MavQshotMode = 5

	/* Start gimbal tracking the point specified by Lat, Lon, Alt. */
	MAV_QSHOT_MODE_POI_TARGETING MavQshotMode = 6

	/* Start gimbal tracking the system with specified system ID. */
	MAV_QSHOT_MODE_SYSID_TARGETING MavQshotMode = 7

	/* Start 2-point cable cam quick shot. */
	MAV_QSHOT_MODE_CABLECAM_2POINT MavQshotMode = 8

	/* Start gimbal tracking the home location. */
	MAV_QSHOT_MODE_HOME_TARGETING MavQshotMode = 9
)
...
type MlrsRadioLinkStatsFlags uint32

const (
	/* Rssi values are in negative dBm. Values 1..254 corresponds to -1..-254 dBm. 0: no reception, UINT8_MAX: unknown. */
	MLRS_RADIO_LINK_STATS_FLAGS_RSSI_DBM MlrsRadioLinkStatsFlags = 0x0001

	/* Rx receive antenna. When set the data received on antenna 2 are taken, else the data stems from antenna 1. */
	MLRS_RADIO_LINK_STATS_FLAGS_RX_RECEIVE_ANTENNA2 MlrsRadioLinkStatsFlags = 0x0002

	/* Rx transmit antenna. Data are transmitted on antenna 1. */
	MLRS_RADIO_LINK_STATS_FLAGS_RX_TRANSMIT_ANTENNA1 MlrsRadioLinkStatsFlags = 0x0004

	/* Rx transmit antenna. Data are transmitted on antenna 2. */
	MLRS_RADIO_LINK_STATS_FLAGS_RX_TRANSMIT_ANTENNA2 MlrsRadioLinkStatsFlags = 0x0008

	/* Tx receive antenna. When set the data received on antenna 2 are taken, else the data stems from antenna 1. */
	MLRS_RADIO_LINK_STATS_FLAGS_TX_RECEIVE_ANTENNA2 MlrsRadioLinkStatsFlags = 0x0010

	/* Tx transmit antenna. Data are transmitted on antenna 1. */
	MLRS_RADIO_LINK_STATS_FLAGS_TX_TRANSMIT_ANTENNA1 MlrsRadioLinkStatsFlags = 0x0020

	/* Tx transmit antenna. Data are transmitted on antenna 2. */
	MLRS_RADIO_LINK_STATS_FLAGS_TX_TRANSMIT_ANTENNA2 MlrsRadioLinkStatsFlags = 0x0040
)

/* RADIO_LINK_TYPE enum. */
type MlrsRadioLinkType uint32

const (
	/* Unknown radio link type. */
	MLRS_RADIO_LINK_TYPE_GENERIC MlrsRadioLinkType = 0

	/* Radio link is HereLink. */
	MLRS_RADIO_LINK_TYPE_HERELINK MlrsRadioLinkType = 1

	/* Radio link is Dragon Link. */
	MLRS_RADIO_LINK_TYPE_DRAGONLINK MlrsRadioLinkType = 2

	/* Radio link is RFD900. */
	MLRS_RADIO_LINK_TYPE_RFD900 MlrsRadioLinkType = 3

	/* Radio link is Crossfire. */
	MLRS_RADIO_LINK_TYPE_CROSSFIRE MlrsRadioLinkType = 4

	/* Radio link is ExpressLRS. */
	MLRS_RADIO_LINK_TYPE_EXPRESSLRS MlrsRadioLinkType = 5

	/* Radio link is mLRS. */
	MLRS_RADIO_LINK_TYPE_MLRS MlrsRadioLinkType = 6
)

type MavAvssCommandFailureReason uint32

const (
	/* AVSS defined command failure reason. PRS not steady. */
	PRS_NOT_STEADY MavAvssCommandFailureReason = 1

	/* AVSS defined command failure reason. PRS DTM not armed. */
	PRS_DTM_NOT_ARMED MavAvssCommandFailureReason = 2

	/* AVSS defined command failure reason. PRS OTM not armed. */
	PRS_OTM_NOT_ARMED MavAvssCommandFailureReason = 3
)

type AvssM300OperationMode uint32

const (
	/* In manual control mode */
	MODE_M300_MANUAL_CTRL AvssM300OperationMode = 0

	/* In attitude mode  */
	MODE_M300_ATTITUDE AvssM300OperationMode = 1

	/* In GPS mode */
	MODE_M300_P_GPS AvssM300OperationMode = 6

	/* In hotpoint mode  */
	MODE_M300_HOTPOINT_MODE AvssM300OperationMode = 9

	/* In assisted takeoff mode */
	MODE_M300_ASSISTED_TAKEOFF AvssM300OperationMode = 10

	/* In auto takeoff mode */
	MODE_M300_AUTO_TAKEOFF AvssM300OperationMode = 11

	/* In auto landing mode */
	MODE_M300_AUTO_LANDING AvssM300OperationMode = 12

	/* In go home mode */
	MODE_M300_NAVI_GO_HOME AvssM300OperationMode = 15

	/* In sdk control mode */
	MODE_M300_NAVI_SDK_CTRL AvssM300OperationMode = 17

	/* In sport mode */
	MODE_M300_S_SPORT AvssM300OperationMode = 31

	/* In force auto landing mode */
	MODE_M300_FORCE_AUTO_LANDING AvssM300OperationMode = 33

	/* In tripod mode */
	MODE_M300_T_TRIPOD AvssM300OperationMode = 38

	/* In search mode */
	MODE_M300_SEARCH_MODE AvssM300OperationMode = 40

	/* In engine mode */
	MODE_M300_ENGINE_START AvssM300OperationMode = 41
)

type AvssHorseflyOperationMode uint32

const (
	/* In manual control mode */
	MODE_HORSEFLY_MANUAL_CTRL AvssHorseflyOperationMode = 0

	/* In auto takeoff mode */
	MODE_HORSEFLY_AUTO_TAKEOFF AvssHorseflyOperationMode = 1

	/* In auto landing mode */
	MODE_HORSEFLY_AUTO_LANDING AvssHorseflyOperationMode = 2

	/* In go home mode */
	MODE_HORSEFLY_NAVI_GO_HOME AvssHorseflyOperationMode = 3

	/* In drop mode */
	MODE_HORSEFLY_DROP AvssHorseflyOperationMode = 4
)
...
type MissionChecksum struct {
	/* CRC32 checksum of current plan for specified type. */
	Checksum uint32

	/* Mission type. */
	MissionType MavMissionType `mavlink:"byte"`
}

func (m *MissionChecksum) ID() int        { return 53 }
func (m *MissionChecksum) CRCExtra() byte { return 3 }

func (m *MissionChecksum) MarshalV1(buf []byte) []byte {
	buf = marshalUint32(buf, (m.Checksum))
	buf = marshalByte(buf, byte(m.MissionType))

	return buf
}

func (m *MissionChecksum) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *MissionChecksum) UnmarshalV1(buf []byte) []byte {

	buf, m.Checksum = unmarshalUint32(buf)
...
func (m *MissionChecksum) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type MountConfigure struct {
	...
	MountMode MavMountMode `mavlink:"byte"`
...
type MountStatus struct {
	...
	/* Mount operating mode. */
	MountMode MavMountMode `mavlink:"byte"` /*EXTENSION*/
...
type LimitsStatus struct {
	...
	/* State of AP_Limits. */
	LimitsState LimitsState `mavlink:"byte"`

	/* AP_Limit_Module bitfield of enabled modules. */
	ModsEnabled LimitModule `mavlink:"byte,bitmask"`

	/* AP_Limit_Module bitfield of required modules. */
	ModsRequired LimitModule `mavlink:"byte,bitmask"`

	/* AP_Limit_Module bitfield of triggered modules. */
	ModsTriggered LimitModule `mavlink:"byte,bitmask"`
}
...
type CameraStatus struct {
	...
	/* Event type. */
	EventId CameraStatusTypes `mavlink:"byte"`
}
...
type CameraFeedback struct {
	...
	/* Feedback flags. */
	Flags CameraFeedbackFlags `mavlink:"byte"`
...
type RemoteLogDataBlock struct {
	...
	Seqno MavRemoteLogDataBlockCommands `mavlink:"uint32"`
...
type RemoteLogBlockStatus struct {
	...
	Status MavRemoteLogDataBlockStatuses `mavlink:"byte"`
}
...
type EkfStatusReport struct {
	...
	/* Flags. */
	Flags EkfStatusFlags `mavlink:"uint16,bitmask"`
...
type PidTuning struct {
	...
	/* Axis. */
	Axis PidTuningAxis `mavlink:"byte"`

	/* Slew rate. */
	Srate float32 /*EXTENSION*/

	/* P/D oscillation modifier. */
	Pdmod float32 /*EXTENSION*/
...
func (m *PidTuning) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)
	buf = marshalFloat32(buf, (m.Srate))
	buf = marshalFloat32(buf, (m.Pdmod))
...
func (m *PidTuning) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
	buf, m.Srate = unmarshalFloat32(buf)
	buf, m.Pdmod = unmarshalFloat32(buf)
...
type Deepstall struct {
	...
	/* Deepstall stage. */
	Stage DeepstallStage `mavlink:"byte"`
}
...
type GoproHeartbeat struct {
	/* Status. */
	Status GoproHeartbeatStatus `mavlink:"byte"`

	/* Current capture mode. */
	CaptureMode GoproCaptureMode `mavlink:"byte"`

	/* Additional status bits. */
	Flags GoproHeartbeatFlags `mavlink:"byte,bitmask"`
}
...
type GoproGetRequest struct {
	...
	/* Command ID. */
	CmdId GoproCommand `mavlink:"byte"`
}
...
type GoproGetResponse struct {
	...
	/* Status. */
	Status GoproRequestStatus `mavlink:"byte"`
...
func (m *CommandIntStamped) ID() int        { return 223 }
func (m *CommandIntStamped) CRCExtra() byte { return 119 }

func (m *CommandIntStamped) MarshalV1(buf []byte) []byte {
	buf = marshalUint64(buf, (m.VehicleTimestamp))
...
func (m *CommandIntStamped) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *CommandIntStamped) UnmarshalV1(buf []byte) []byte {

	buf, m.VehicleTimestamp = unmarshalUint64(buf)
...
func (m *CommandIntStamped) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
func (m *CommandLongStamped) ID() int        { return 224 }
func (m *CommandLongStamped) CRCExtra() byte { return 102 }

func (m *CommandLongStamped) MarshalV1(buf []byte) []byte {
	buf = marshalUint64(buf, (m.VehicleTimestamp))
	buf = marshalUint32(buf, (m.UtcTime))
	buf = marshalFloat32(buf, (m.Param1))
	buf = marshalFloat32(buf, (m.Param2))
...
func (m *CommandLongStamped) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *CommandLongStamped) UnmarshalV1(buf []byte) []byte {
...
func (m *CommandLongStamped) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type RadioRcChannels struct {
	...
	Flags RadioRcChannelsFlags `mavlink:"uint16,bitmask"`
	...
	Channels [32]int16 /*EXTENSION*/

}

func (m *RadioRcChannels) ID() int        { return 420 }
func (m *RadioRcChannels) CRCExtra() byte { return 20 }

func (m *RadioRcChannels) MarshalV1(buf []byte) []byte {
	buf = marshalUint32(buf, (m.TimeLastUpdateMs))
	buf = marshalUint16(buf, uint16(m.Flags))
	buf = marshalByte(buf, (m.TargetSystem))
	buf = marshalByte(buf, (m.TargetComponent))
	buf = marshalByte(buf, (m.Count))
...
func (m *RadioRcChannels) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)
...
func (m *RadioRcChannels) UnmarshalV1(buf []byte) []byte {

	buf, m.TimeLastUpdateMs = unmarshalUint32(buf)

	{
		var v uint16
		buf, v = unmarshalUint16(buf)
		m.Flags = RadioRcChannelsFlags(v)
	}
...
func (m *RadioRcChannels) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
	for i, _ := range m.Channels {
		buf, m.Channels[i] = unmarshalInt16(buf)
	}
...
type GnssIntegrity struct {
	/* Errors in the GPS system. */
	SystemErrors GpsSystemErrorFlags `mavlink:"uint32,bitmask"`
	...
	AuthenticationState GpsAuthenticationState `mavlink:"byte"`

	/* Signal jamming state of the GPS system. */
	JammingState GpsJammingState `mavlink:"byte"`

	/* Signal spoofing state of the GPS system. */
	SpoofingState GpsSpoofingState `mavlink:"byte"`

	/* The state of the RAIM processing. */
	RaimState GpsRaimState `mavlink:"byte"`

	/* An abstract value representing the estimated quality of incoming corrections, or 255 if not available. */
	CorrectionsQuality byte

	/* An abstract value representing the overall status of the receiver, or 255 if not available. */
	SystemStatusSummary byte

	/* An abstract value representing the quality of incoming GNSS signals, or 255 if not available. */
	GnssSignalQuality byte

	/* An abstract value representing the estimated PPK quality, or 255 if not available. */
	PostProcessingQuality byte
}

func (m *GnssIntegrity) ID() int        { return 441 }
func (m *GnssIntegrity) CRCExtra() byte { return 169 }

func (m *GnssIntegrity) MarshalV1(buf []byte) []byte {
	buf = marshalUint32(buf, uint32(m.SystemErrors))
	buf = marshalUint16(buf, (m.RaimHfom))
	buf = marshalUint16(buf, (m.RaimVfom))
	buf = marshalByte(buf, (m.Id))
	buf = marshalByte(buf, byte(m.AuthenticationState))
	buf = marshalByte(buf, byte(m.JammingState))
	buf = marshalByte(buf, byte(m.SpoofingState))
	buf = marshalByte(buf, byte(m.RaimState))
	buf = marshalByte(buf, (m.CorrectionsQuality))
	buf = marshalByte(buf, (m.SystemStatusSummary))
	buf = marshalByte(buf, (m.GnssSignalQuality))
	buf = marshalByte(buf, (m.PostProcessingQuality))

	return buf
}

func (m *GnssIntegrity) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *GnssIntegrity) UnmarshalV1(buf []byte) []byte {

	{
		var v uint32
		buf, v = unmarshalUint32(buf)
		m.SystemErrors = GpsSystemErrorFlags(v)
	}

	buf, m.RaimHfom = unmarshalUint16(buf)

	buf, m.RaimVfom = unmarshalUint16(buf)
...

	{
		var v byte
		buf, v = unmarshalByte(buf)
		m.AuthenticationState = GpsAuthenticationState(v)
	}

	{
		var v byte
		buf, v = unmarshalByte(buf)
		m.JammingState = GpsJammingState(v)
	}

	{
		var v byte
		buf, v = unmarshalByte(buf)
		m.SpoofingState = GpsSpoofingState(v)
	}

	{
		var v byte
		buf, v = unmarshalByte(buf)
		m.RaimState = GpsRaimState(v)
	}

	buf, m.CorrectionsQuality = unmarshalByte(buf)

	buf, m.SystemStatusSummary = unmarshalByte(buf)

	buf, m.GnssSignalQuality = unmarshalByte(buf)

	buf, m.PostProcessingQuality = unmarshalByte(buf)

	return buf
}

func (m *GnssIntegrity) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
func (m *SensPower) ID() int        { return 8002 }
func (m *SensPower) CRCExtra() byte { return 218 }

func (m *SensPower) MarshalV1(buf []byte) []byte {
	buf = marshalFloat32(buf, (m.Adc121VspbVolt))
	buf = marshalFloat32(buf, (m.Adc121CspbAmp))
	buf = marshalFloat32(buf, (m.Adc121Cs1Amp))
	buf = marshalFloat32(buf, (m.Adc121Cs2Amp))

	return buf
}

func (m *SensPower) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *SensPower) UnmarshalV1(buf []byte) []byte {

	buf, m.Adc121VspbVolt = unmarshalFloat32(buf)

	buf, m.Adc121CspbAmp = unmarshalFloat32(buf)

	buf, m.Adc121Cs1Amp = unmarshalFloat32(buf)

	buf, m.Adc121Cs2Amp = unmarshalFloat32(buf)

	return buf
}

func (m *SensPower) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
func (m *SensMppt) ID() int        { return 8003 }
func (m *SensMppt) CRCExtra() byte { return 231 }

func (m *SensMppt) MarshalV1(buf []byte) []byte {
	buf = marshalUint64(buf, (m.MpptTimestamp))
	buf = marshalFloat32(buf, (m.Mppt1Volt))
	buf = marshalFloat32(buf, (m.Mppt1Amp))
	buf = marshalFloat32(buf, (m.Mppt2Volt))
	buf = marshalFloat32(buf, (m.Mppt2Amp))
	buf = marshalFloat32(buf, (m.Mppt3Volt))
	buf = marshalFloat32(buf, (m.Mppt3Amp))
	buf = marshalUint16(buf, (m.Mppt1Pwm))
	buf = marshalUint16(buf, (m.Mppt2Pwm))
	buf = marshalUint16(buf, (m.Mppt3Pwm))
	buf = marshalByte(buf, (m.Mppt1Status))
	buf = marshalByte(buf, (m.Mppt2Status))
	buf = marshalByte(buf, (m.Mppt3Status))

	return buf
}

func (m *SensMppt) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *SensMppt) UnmarshalV1(buf []byte) []byte {

	buf, m.MpptTimestamp = unmarshalUint64(buf)

	buf, m.Mppt1Volt = unmarshalFloat32(buf)

	buf, m.Mppt1Amp = unmarshalFloat32(buf)

	buf, m.Mppt2Volt = unmarshalFloat32(buf)

	buf, m.Mppt2Amp = unmarshalFloat32(buf)

	buf, m.Mppt3Volt = unmarshalFloat32(buf)

	buf, m.Mppt3Amp = unmarshalFloat32(buf)

	buf, m.Mppt1Pwm = unmarshalUint16(buf)

	buf, m.Mppt2Pwm = unmarshalUint16(buf)

	buf, m.Mppt3Pwm = unmarshalUint16(buf)

	buf, m.Mppt1Status = unmarshalByte(buf)

	buf, m.Mppt2Status = unmarshalByte(buf)

	buf, m.Mppt3Status = unmarshalByte(buf)

	return buf
}

func (m *SensMppt) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type AslctrlData struct {
	...
	/*   */
	Spoilersengaged byte
}

func (m *AslctrlData) ID() int        { return 8004 }
func (m *AslctrlData) CRCExtra() byte { return 172 }

func (m *AslctrlData) MarshalV1(buf []byte) []byte {
	buf = marshalUint64(buf, (m.Timestamp))
	buf = marshalFloat32(buf, (m.H))
	buf = marshalFloat32(buf, (m.Href))
	buf = marshalFloat32(buf, (m.HrefT))
	buf = marshalFloat32(buf, (m.Pitchangle))
	buf = marshalFloat32(buf, (m.Pitchangleref))
	buf = marshalFloat32(buf, (m.Q))
	buf = marshalFloat32(buf, (m.Qref))
	buf = marshalFloat32(buf, (m.Uelev))
	buf = marshalFloat32(buf, (m.Uthrot))
	buf = marshalFloat32(buf, (m.Uthrot2))
	buf = marshalFloat32(buf, (m.Nz))
	buf = marshalFloat32(buf, (m.Airspeedref))
	buf = marshalFloat32(buf, (m.Yawangle))
	buf = marshalFloat32(buf, (m.Yawangleref))
	buf = marshalFloat32(buf, (m.Rollangle))
	buf = marshalFloat32(buf, (m.Rollangleref))
	buf = marshalFloat32(buf, (m.P))
	buf = marshalFloat32(buf, (m.Pref))
	buf = marshalFloat32(buf, (m.R))
	buf = marshalFloat32(buf, (m.Rref))
	buf = marshalFloat32(buf, (m.Uail))
	buf = marshalFloat32(buf, (m.Urud))
	buf = marshalByte(buf, (m.AslctrlMode))
	buf = marshalByte(buf, (m.Spoilersengaged))

	return buf
}

func (m *AslctrlData) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *AslctrlData) UnmarshalV1(buf []byte) []byte {

	buf, m.Timestamp = unmarshalUint64(buf)

	buf, m.H = unmarshalFloat32(buf)

	buf, m.Href = unmarshalFloat32(buf)

	buf, m.HrefT = unmarshalFloat32(buf)

	buf, m.Pitchangle = unmarshalFloat32(buf)

	buf, m.Pitchangleref = unmarshalFloat32(buf)

	buf, m.Q = unmarshalFloat32(buf)

	buf, m.Qref = unmarshalFloat32(buf)

	buf, m.Uelev = unmarshalFloat32(buf)

	buf, m.Uthrot = unmarshalFloat32(buf)

	buf, m.Uthrot2 = unmarshalFloat32(buf)

	buf, m.Nz = unmarshalFloat32(buf)

	buf, m.Airspeedref = unmarshalFloat32(buf)

	buf, m.Yawangle = unmarshalFloat32(buf)

	buf, m.Yawangleref = unmarshalFloat32(buf)

	buf, m.Rollangle = unmarshalFloat32(buf)

	buf, m.Rollangleref = unmarshalFloat32(buf)

	buf, m.P = unmarshalFloat32(buf)

	buf, m.Pref = unmarshalFloat32(buf)

	buf, m.R = unmarshalFloat32(buf)

	buf, m.Rref = unmarshalFloat32(buf)

	buf, m.Uail = unmarshalFloat32(buf)

	buf, m.Urud = unmarshalFloat32(buf)

	buf, m.AslctrlMode = unmarshalByte(buf)

	buf, m.Spoilersengaged = unmarshalByte(buf)

	return buf
}

func (m *AslctrlData) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
func (m *AslctrlDebug) ID() int        { return 8005 }
func (m *AslctrlDebug) CRCExtra() byte { return 251 }

func (m *AslctrlDebug) MarshalV1(buf []byte) []byte {
	buf = marshalUint32(buf, (m.I321))
	buf = marshalFloat32(buf, (m.F1))
	buf = marshalFloat32(buf, (m.F2))
	buf = marshalFloat32(buf, (m.F3))
	buf = marshalFloat32(buf, (m.F4))
	buf = marshalFloat32(buf, (m.F5))
	buf = marshalFloat32(buf, (m.F6))
	buf = marshalFloat32(buf, (m.F7))
	buf = marshalFloat32(buf, (m.F8))
	buf = marshalByte(buf, (m.I81))
	buf = marshalByte(buf, (m.I82))

	return buf
}

func (m *AslctrlDebug) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *AslctrlDebug) UnmarshalV1(buf []byte) []byte {

	buf, m.I321 = unmarshalUint32(buf)

	buf, m.F1 = unmarshalFloat32(buf)

	buf, m.F2 = unmarshalFloat32(buf)

	buf, m.F3 = unmarshalFloat32(buf)

	buf, m.F4 = unmarshalFloat32(buf)

	buf, m.F5 = unmarshalFloat32(buf)

	buf, m.F6 = unmarshalFloat32(buf)

	buf, m.F7 = unmarshalFloat32(buf)

	buf, m.F8 = unmarshalFloat32(buf)

	buf, m.I81 = unmarshalByte(buf)

	buf, m.I82 = unmarshalByte(buf)

	return buf
}

func (m *AslctrlDebug) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
func (m *AsluavStatus) ID() int        { return 8006 }
func (m *AsluavStatus) CRCExtra() byte { return 97 }

func (m *AsluavStatus) MarshalV1(buf []byte) []byte {
	buf = marshalFloat32(buf, (m.MotorRpm))
	buf = marshalByte(buf, (m.LedStatus))
	buf = marshalByte(buf, (m.SatcomStatus))
	for _, v := range m.ServoStatus {
		buf = marshalByte(buf, (v))
	}
...
func (m *AsluavStatus) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *AsluavStatus) UnmarshalV1(buf []byte) []byte {

	buf, m.MotorRpm = unmarshalFloat32(buf)

	buf, m.LedStatus = unmarshalByte(buf)

	buf, m.SatcomStatus = unmarshalByte(buf)

	for i, _ := range m.ServoStatus {
		buf, m.ServoStatus[i] = unmarshalByte(buf)
	}

	return buf
}

func (m *AsluavStatus) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
func (m *EkfExt) ID() int        { return 8007 }
func (m *EkfExt) CRCExtra() byte { return 64 }

func (m *EkfExt) MarshalV1(buf []byte) []byte {
	buf = marshalUint64(buf, (m.Timestamp))
	buf = marshalFloat32(buf, (m.Windspeed))
	buf = marshalFloat32(buf, (m.Winddir))
	buf = marshalFloat32(buf, (m.Windz))
	buf = marshalFloat32(buf, (m.Airspeed))
	buf = marshalFloat32(buf, (m.Beta))
	buf = marshalFloat32(buf, (m.Alpha))

	return buf
}

func (m *EkfExt) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *EkfExt) UnmarshalV1(buf []byte) []byte {

	buf, m.Timestamp = unmarshalUint64(buf)

	buf, m.Windspeed = unmarshalFloat32(buf)

	buf, m.Winddir = unmarshalFloat32(buf)

	buf, m.Windz = unmarshalFloat32(buf)

	buf, m.Airspeed = unmarshalFloat32(buf)

	buf, m.Beta = unmarshalFloat32(buf)

	buf, m.Alpha = unmarshalFloat32(buf)

	return buf
}

func (m *EkfExt) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
func (m *AslObctrl) ID() int        { return 8008 }
func (m *AslObctrl) CRCExtra() byte { return 234 }

func (m *AslObctrl) MarshalV1(buf []byte) []byte {
	buf = marshalUint64(buf, (m.Timestamp))
	buf = marshalFloat32(buf, (m.Uelev))
	buf = marshalFloat32(buf, (m.Uthrot))
	buf = marshalFloat32(buf, (m.Uthrot2))
	buf = marshalFloat32(buf, (m.Uaill))
	buf = marshalFloat32(buf, (m.Uailr))
	buf = marshalFloat32(buf, (m.Urud))
	buf = marshalByte(buf, (m.ObctrlStatus))

	return buf
}

func (m *AslObctrl) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *AslObctrl) UnmarshalV1(buf []byte) []byte {
	...
	buf, m.Uaill = unmarshalFloat32(buf)

	buf, m.Uailr = unmarshalFloat32(buf)

	buf, m.Urud = unmarshalFloat32(buf)

	buf, m.ObctrlStatus = unmarshalByte(buf)

	return buf
}

func (m *AslObctrl) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
func (m *SensAtmos) ID() int        { return 8009 }
func (m *SensAtmos) CRCExtra() byte { return 144 }

func (m *SensAtmos) MarshalV1(buf []byte) []byte {
	buf = marshalUint64(buf, (m.Timestamp))
	buf = marshalFloat32(buf, (m.Tempambient))
	buf = marshalFloat32(buf, (m.Humidity))

	return buf
}

func (m *SensAtmos) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *SensAtmos) UnmarshalV1(buf []byte) []byte {

	buf, m.Timestamp = unmarshalUint64(buf)

	buf, m.Tempambient = unmarshalFloat32(buf)

	buf, m.Humidity = unmarshalFloat32(buf)

	return buf
}

func (m *SensAtmos) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
func (m *SensBatmon) ID() int        { return 8010 }
func (m *SensBatmon) CRCExtra() byte { return 155 }

func (m *SensBatmon) MarshalV1(buf []byte) []byte {
	buf = marshalUint64(buf, (m.BatmonTimestamp))
	buf = marshalFloat32(buf, (m.Temperature))
	buf = marshalUint32(buf, (m.Safetystatus))
	buf = marshalUint32(buf, (m.Operationstatus))
	buf = marshalUint16(buf, (m.Voltage))
	buf = marshalInt16(buf, (m.Current))
	buf = marshalUint16(buf, (m.Batterystatus))
	buf = marshalUint16(buf, (m.Serialnumber))
	buf = marshalUint16(buf, (m.Cellvoltage1))
	buf = marshalUint16(buf, (m.Cellvoltage2))
	buf = marshalUint16(buf, (m.Cellvoltage3))
	buf = marshalUint16(buf, (m.Cellvoltage4))
	buf = marshalUint16(buf, (m.Cellvoltage5))
	buf = marshalUint16(buf, (m.Cellvoltage6))
	buf = marshalByte(buf, (m.Soc))

	return buf
}

func (m *SensBatmon) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *SensBatmon) UnmarshalV1(buf []byte) []byte {

	buf, m.BatmonTimestamp = unmarshalUint64(buf)

	buf, m.Temperature = unmarshalFloat32(buf)

	buf, m.Safetystatus = unmarshalUint32(buf)

	buf, m.Operationstatus = unmarshalUint32(buf)

	buf, m.Voltage = unmarshalUint16(buf)

	buf, m.Current = unmarshalInt16(buf)

	buf, m.Batterystatus = unmarshalUint16(buf)

	buf, m.Serialnumber = unmarshalUint16(buf)

	buf, m.Cellvoltage1 = unmarshalUint16(buf)

	buf, m.Cellvoltage2 = unmarshalUint16(buf)

	buf, m.Cellvoltage3 = unmarshalUint16(buf)

	buf, m.Cellvoltage4 = unmarshalUint16(buf)

	buf, m.Cellvoltage5 = unmarshalUint16(buf)

	buf, m.Cellvoltage6 = unmarshalUint16(buf)

	buf, m.Soc = unmarshalByte(buf)

	return buf
}

func (m *SensBatmon) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
func (m *FwSoaringData) ID() int        { return 8011 }
func (m *FwSoaringData) CRCExtra() byte { return 20 }

func (m *FwSoaringData) MarshalV1(buf []byte) []byte {
	buf = marshalUint64(buf, (m.Timestamp))
	buf = marshalUint64(buf, (m.Timestampmodechanged))
	buf = marshalFloat32(buf, (m.Xw))
	buf = marshalFloat32(buf, (m.Xr))
	buf = marshalFloat32(buf, (m.Xlat))
	buf = marshalFloat32(buf, (m.Xlon))
	buf = marshalFloat32(buf, (m.Varw))
	buf = marshalFloat32(buf, (m.Varr))
	buf = marshalFloat32(buf, (m.Varlat))
	buf = marshalFloat32(buf, (m.Varlon))
	buf = marshalFloat32(buf, (m.Loiterradius))
	buf = marshalFloat32(buf, (m.Loiterdirection))
	buf = marshalFloat32(buf, (m.Disttosoarpoint))
	buf = marshalFloat32(buf, (m.Vsinkexp))
	buf = marshalFloat32(buf, (m.Z1Localupdraftspeed))
	buf = marshalFloat32(buf, (m.Z2Deltaroll))
	buf = marshalFloat32(buf, (m.Z1Exp))
	buf = marshalFloat32(buf, (m.Z2Exp))
	buf = marshalFloat32(buf, (m.Thermalgsnorth))
	buf = marshalFloat32(buf, (m.Thermalgseast))
	buf = marshalFloat32(buf, (m.TseDot))
	buf = marshalFloat32(buf, (m.Debugvar1))
	buf = marshalFloat32(buf, (m.Debugvar2))
	buf = marshalByte(buf, (m.Controlmode))
	buf = marshalByte(buf, (m.Valid))

	return buf
}

func (m *FwSoaringData) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *FwSoaringData) UnmarshalV1(buf []byte) []byte {

	buf, m.Timestamp = unmarshalUint64(buf)

	buf, m.Timestampmodechanged = unmarshalUint64(buf)

	buf, m.Xw = unmarshalFloat32(buf)

	buf, m.Xr = unmarshalFloat32(buf)

	buf, m.Xlat = unmarshalFloat32(buf)

	buf, m.Xlon = unmarshalFloat32(buf)

	buf, m.Varw = unmarshalFloat32(buf)

	buf, m.Varr = unmarshalFloat32(buf)

	buf, m.Varlat = unmarshalFloat32(buf)

	buf, m.Varlon = unmarshalFloat32(buf)

	buf, m.Loiterradius = unmarshalFloat32(buf)

	buf, m.Loiterdirection = unmarshalFloat32(buf)

	buf, m.Disttosoarpoint = unmarshalFloat32(buf)

	buf, m.Vsinkexp = unmarshalFloat32(buf)

	buf, m.Z1Localupdraftspeed = unmarshalFloat32(buf)

	buf, m.Z2Deltaroll = unmarshalFloat32(buf)

	buf, m.Z1Exp = unmarshalFloat32(buf)

	buf, m.Z2Exp = unmarshalFloat32(buf)

	buf, m.Thermalgsnorth = unmarshalFloat32(buf)

	buf, m.Thermalgseast = unmarshalFloat32(buf)

	buf, m.TseDot = unmarshalFloat32(buf)

	buf, m.Debugvar1 = unmarshalFloat32(buf)

	buf, m.Debugvar2 = unmarshalFloat32(buf)

	buf, m.Controlmode = unmarshalByte(buf)

	buf, m.Valid = unmarshalByte(buf)

	return buf
}

func (m *FwSoaringData) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type SensorpodStatus struct {
	...
	RecordingNodesCount byte

	/* Temperature of sensorpod CPU in */
	CpuTemp byte
}

func (m *SensorpodStatus) ID() int        { return 8012 }
func (m *SensorpodStatus) CRCExtra() byte { return 54 }

func (m *SensorpodStatus) MarshalV1(buf []byte) []byte {
	buf = marshalUint64(buf, (m.Timestamp))
	buf = marshalUint16(buf, (m.FreeSpace))
	buf = marshalByte(buf, (m.VisensorRate1))
	buf = marshalByte(buf, (m.VisensorRate2))
	buf = marshalByte(buf, (m.VisensorRate3))
	buf = marshalByte(buf, (m.VisensorRate4))
	buf = marshalByte(buf, (m.RecordingNodesCount))
	buf = marshalByte(buf, (m.CpuTemp))

	return buf
}

func (m *SensorpodStatus) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *SensorpodStatus) UnmarshalV1(buf []byte) []byte {

	buf, m.Timestamp = unmarshalUint64(buf)

	buf, m.FreeSpace = unmarshalUint16(buf)

	buf, m.VisensorRate1 = unmarshalByte(buf)

	buf, m.VisensorRate2 = unmarshalByte(buf)

	buf, m.VisensorRate3 = unmarshalByte(buf)

	buf, m.VisensorRate4 = unmarshalByte(buf)

	buf, m.RecordingNodesCount = unmarshalByte(buf)

	buf, m.CpuTemp = unmarshalByte(buf)

	return buf
}

func (m *SensorpodStatus) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type SensPowerBoard struct {
	...
	PwrBrdLedStatus byte
}

func (m *SensPowerBoard) ID() int        { return 8013 }
func (m *SensPowerBoard) CRCExtra() byte { return 222 }

func (m *SensPowerBoard) MarshalV1(buf []byte) []byte {
	buf = marshalUint64(buf, (m.Timestamp))
	buf = marshalFloat32(buf, (m.PwrBrdSystemVolt))
	buf = marshalFloat32(buf, (m.PwrBrdServoVolt))
	buf = marshalFloat32(buf, (m.PwrBrdDigitalVolt))
	buf = marshalFloat32(buf, (m.PwrBrdMotLAmp))
	buf = marshalFloat32(buf, (m.PwrBrdMotRAmp))
	buf = marshalFloat32(buf, (m.PwrBrdAnalogAmp))
	buf = marshalFloat32(buf, (m.PwrBrdDigitalAmp))
	buf = marshalFloat32(buf, (m.PwrBrdExtAmp))
	buf = marshalFloat32(buf, (m.PwrBrdAuxAmp))
	buf = marshalByte(buf, (m.PwrBrdStatus))
	buf = marshalByte(buf, (m.PwrBrdLedStatus))

	return buf
}

func (m *SensPowerBoard) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *SensPowerBoard) UnmarshalV1(buf []byte) []byte {

	buf, m.Timestamp = unmarshalUint64(buf)

	buf, m.PwrBrdSystemVolt = unmarshalFloat32(buf)

	buf, m.PwrBrdServoVolt = unmarshalFloat32(buf)

	buf, m.PwrBrdDigitalVolt = unmarshalFloat32(buf)

	buf, m.PwrBrdMotLAmp = unmarshalFloat32(buf)

	buf, m.PwrBrdMotRAmp = unmarshalFloat32(buf)

	buf, m.PwrBrdAnalogAmp = unmarshalFloat32(buf)

	buf, m.PwrBrdDigitalAmp = unmarshalFloat32(buf)

	buf, m.PwrBrdExtAmp = unmarshalFloat32(buf)

	buf, m.PwrBrdAuxAmp = unmarshalFloat32(buf)

	buf, m.PwrBrdStatus = unmarshalByte(buf)

	buf, m.PwrBrdLedStatus = unmarshalByte(buf)

	return buf
}

func (m *SensPowerBoard) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type GsmLinkStatus struct {
	...
	/* GSM modem used */
	GsmModemType GsmModemType `mavlink:"byte"`

	/* GSM link type */
	GsmLinkType GsmLinkType `mavlink:"byte"`
...
func (m *GsmLinkStatus) ID() int        { return 8014 }
func (m *GsmLinkStatus) CRCExtra() byte { return 200 }

func (m *GsmLinkStatus) MarshalV1(buf []byte) []byte {
	buf = marshalUint64(buf, (m.Timestamp))
	buf = marshalByte(buf, byte(m.GsmModemType))
	buf = marshalByte(buf, byte(m.GsmLinkType))
	buf = marshalByte(buf, (m.Rssi))
	buf = marshalByte(buf, (m.RsrpRscp))
	buf = marshalByte(buf, (m.SinrEcio))
	buf = marshalByte(buf, (m.Rsrq))

	return buf
}

func (m *GsmLinkStatus) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *GsmLinkStatus) UnmarshalV1(buf []byte) []byte {
...

	{
		var v byte
		buf, v = unmarshalByte(buf)
		m.GsmModemType = GsmModemType(v)
	}

	{
		var v byte
		buf, v = unmarshalByte(buf)
		m.GsmLinkType = GsmLinkType(v)
	}

	buf, m.Rssi = unmarshalByte(buf)

	buf, m.RsrpRscp = unmarshalByte(buf)

	buf, m.SinrEcio = unmarshalByte(buf)

	buf, m.Rsrq = unmarshalByte(buf)

	return buf
}

func (m *GsmLinkStatus) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
func (m *SatcomLinkStatus) ID() int        { return 8015 }
func (m *SatcomLinkStatus) CRCExtra() byte { return 23 }

func (m *SatcomLinkStatus) MarshalV1(buf []byte) []byte {
	buf = marshalUint64(buf, (m.Timestamp))
	buf = marshalUint64(buf, (m.LastHeartbeat))
	buf = marshalUint16(buf, (m.FailedSessions))
	buf = marshalUint16(buf, (m.SuccessfulSessions))
...
func (m *SatcomLinkStatus) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *SatcomLinkStatus) UnmarshalV1(buf []byte) []byte {
...
func (m *SatcomLinkStatus) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type SensorAirflowAngles struct {
	...
	AngleofattackValid byte

	/* Sideslip angle measurement valid */
	SideslipValid byte
}

func (m *SensorAirflowAngles) ID() int        { return 8016 }
func (m *SensorAirflowAngles) CRCExtra() byte { return 149 }

func (m *SensorAirflowAngles) MarshalV1(buf []byte) []byte {
	buf = marshalUint64(buf, (m.Timestamp))
	buf = marshalFloat32(buf, (m.Angleofattack))
	buf = marshalFloat32(buf, (m.Sideslip))
	buf = marshalByte(buf, (m.AngleofattackValid))
	buf = marshalByte(buf, (m.SideslipValid))

	return buf
}

func (m *SensorAirflowAngles) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *SensorAirflowAngles) UnmarshalV1(buf []byte) []byte {

	buf, m.Timestamp = unmarshalUint64(buf)

	buf, m.Angleofattack = unmarshalFloat32(buf)

	buf, m.Sideslip = unmarshalFloat32(buf)

	buf, m.AngleofattackValid = unmarshalByte(buf)

	buf, m.SideslipValid = unmarshalByte(buf)

	return buf
}

func (m *SensorAirflowAngles) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
func (m *LoweheiserGovEfi) ID() int        { return 10151 }
func (m *LoweheiserGovEfi) CRCExtra() byte { return 195 }

func (m *LoweheiserGovEfi) MarshalV1(buf []byte) []byte {
	buf = marshalFloat32(buf, (m.VoltBatt))
	buf = marshalFloat32(buf, (m.CurrBatt))
	buf = marshalFloat32(buf, (m.CurrGen))
	buf = marshalFloat32(buf, (m.CurrRot))
	buf = marshalFloat32(buf, (m.FuelLevel))
	buf = marshalFloat32(buf, (m.Throttle))
	buf = marshalUint32(buf, (m.Runtime))
	buf = marshalInt32(buf, (m.UntilMaintenance))
	buf = marshalFloat32(buf, (m.RectifierTemp))
	buf = marshalFloat32(buf, (m.GeneratorTemp))
	buf = marshalFloat32(buf, (m.EfiBatt))
	buf = marshalFloat32(buf, (m.EfiRpm))
	buf = marshalFloat32(buf, (m.EfiPw))
	buf = marshalFloat32(buf, (m.EfiFuelFlow))
	buf = marshalFloat32(buf, (m.EfiFuelConsumed))
	buf = marshalFloat32(buf, (m.EfiBaro))
	buf = marshalFloat32(buf, (m.EfiMat))
	buf = marshalFloat32(buf, (m.EfiClt))
	buf = marshalFloat32(buf, (m.EfiTps))
	buf = marshalFloat32(buf, (m.EfiExhaustGasTemperature))
	buf = marshalUint16(buf, (m.GeneratorStatus))
	buf = marshalUint16(buf, (m.EfiStatus))
	buf = marshalByte(buf, (m.EfiIndex))

	return buf
}

func (m *LoweheiserGovEfi) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *LoweheiserGovEfi) UnmarshalV1(buf []byte) []byte {

	buf, m.VoltBatt = unmarshalFloat32(buf)

	buf, m.CurrBatt = unmarshalFloat32(buf)

	buf, m.CurrGen = unmarshalFloat32(buf)

	buf, m.CurrRot = unmarshalFloat32(buf)

	buf, m.FuelLevel = unmarshalFloat32(buf)

	buf, m.Throttle = unmarshalFloat32(buf)

	buf, m.Runtime = unmarshalUint32(buf)

	buf, m.UntilMaintenance = unmarshalInt32(buf)

	buf, m.RectifierTemp = unmarshalFloat32(buf)

	buf, m.GeneratorTemp = unmarshalFloat32(buf)

	buf, m.EfiBatt = unmarshalFloat32(buf)

	buf, m.EfiRpm = unmarshalFloat32(buf)

	buf, m.EfiPw = unmarshalFloat32(buf)

	buf, m.EfiFuelFlow = unmarshalFloat32(buf)

	buf, m.EfiFuelConsumed = unmarshalFloat32(buf)

	buf, m.EfiBaro = unmarshalFloat32(buf)

	buf, m.EfiMat = unmarshalFloat32(buf)

	buf, m.EfiClt = unmarshalFloat32(buf)

	buf, m.EfiTps = unmarshalFloat32(buf)

	buf, m.EfiExhaustGasTemperature = unmarshalFloat32(buf)

	buf, m.GeneratorStatus = unmarshalUint16(buf)

	buf, m.EfiStatus = unmarshalUint16(buf)

	buf, m.EfiIndex = unmarshalByte(buf)

	return buf
}

func (m *LoweheiserGovEfi) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type DeviceOpRead struct {
	...
	/* The bus type. */
	Bustype DeviceOpBustype `mavlink:"byte"`
...
type SecureCommand struct {
	...
	Operation SecureCommandOp `mavlink:"uint32"`
...
func (m *SecureCommand) ID() int        { return 11004 }
func (m *SecureCommand) CRCExtra() byte { return 11 }

func (m *SecureCommand) MarshalV1(buf []byte) []byte {
	buf = marshalUint32(buf, (m.Sequence))
	buf = marshalUint32(buf, uint32(m.Operation))
	buf = marshalByte(buf, (m.TargetSystem))
	buf = marshalByte(buf, (m.TargetComponent))
	buf = marshalByte(buf, (m.DataLength))
	buf = marshalByte(buf, (m.SigLength))
	for _, v := range m.Data {
		buf = marshalByte(buf, (v))
	}
...
func (m *SecureCommand) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *SecureCommand) UnmarshalV1(buf []byte) []byte {

	buf, m.Sequence = unmarshalUint32(buf)

	{
		var v uint32
		buf, v = unmarshalUint32(buf)
		m.Operation = SecureCommandOp(v)
	}
	...
	buf, m.DataLength = unmarshalByte(buf)

	buf, m.SigLength = unmarshalByte(buf)
...
func (m *SecureCommand) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type SecureCommandReply struct {
...
func (m *SecureCommandReply) ID() int        { return 11005 }
func (m *SecureCommandReply) CRCExtra() byte { return 93 }

func (m *SecureCommandReply) MarshalV1(buf []byte) []byte {
	buf = marshalUint32(buf, (m.Sequence))
	buf = marshalUint32(buf, uint32(m.Operation))
	buf = marshalByte(buf, byte(m.Result))
	buf = marshalByte(buf, (m.DataLength))
...
func (m *SecureCommandReply) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *SecureCommandReply) UnmarshalV1(buf []byte) []byte {
...
func (m *SecureCommandReply) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type OsdParamConfig struct {
	...
	/* Config type. */
	ConfigType OsdParamConfigType `mavlink:"byte"`
}

func (m *OsdParamConfig) ID() int        { return 11033 }
func (m *OsdParamConfig) CRCExtra() byte { return 195 }

func (m *OsdParamConfig) MarshalV1(buf []byte) []byte {
	buf = marshalUint32(buf, (m.RequestId))
	buf = marshalFloat32(buf, (m.MinValue))
	buf = marshalFloat32(buf, (m.MaxValue))
	buf = marshalFloat32(buf, (m.Increment))
	buf = marshalByte(buf, (m.TargetSystem))
	buf = marshalByte(buf, (m.TargetComponent))
	buf = marshalByte(buf, (m.OsdScreen))
	buf = marshalByte(buf, (m.OsdIndex))
	for _, v := range m.ParamId {
		buf = marshalByte(buf, (v))
	}
	buf = marshalByte(buf, byte(m.ConfigType))

	return buf
}

func (m *OsdParamConfig) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *OsdParamConfig) UnmarshalV1(buf []byte) []byte {

	buf, m.RequestId = unmarshalUint32(buf)

	buf, m.MinValue = unmarshalFloat32(buf)

	buf, m.MaxValue = unmarshalFloat32(buf)

	buf, m.Increment = unmarshalFloat32(buf)

	buf, m.TargetSystem = unmarshalByte(buf)

	buf, m.TargetComponent = unmarshalByte(buf)

	buf, m.OsdScreen = unmarshalByte(buf)

	buf, m.OsdIndex = unmarshalByte(buf)
...

	{
		var v byte
		buf, v = unmarshalByte(buf)
		m.ConfigType = OsdParamConfigType(v)
	}

	return buf
}

func (m *OsdParamConfig) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type OsdParamConfigReply struct {
	/* Request ID - copied from request. */
	RequestId uint32

	/* Config error type. */
	Result OsdParamConfigError `mavlink:"byte"`
}

func (m *OsdParamConfigReply) ID() int        { return 11034 }
func (m *OsdParamConfigReply) CRCExtra() byte { return 79 }

func (m *OsdParamConfigReply) MarshalV1(buf []byte) []byte {
	buf = marshalUint32(buf, (m.RequestId))
	buf = marshalByte(buf, byte(m.Result))
...
func (m *OsdParamConfigReply) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *OsdParamConfigReply) UnmarshalV1(buf []byte) []byte {
...

	{
		var v byte
		buf, v = unmarshalByte(buf)
		m.Result = OsdParamConfigError(v)
	}

	return buf
}

func (m *OsdParamConfigReply) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type OsdParamShowConfig struct {
	/* Request ID - copied to reply. */
	RequestId uint32
...
func (m *OsdParamShowConfig) ID() int        { return 11035 }
func (m *OsdParamShowConfig) CRCExtra() byte { return 128 }

func (m *OsdParamShowConfig) MarshalV1(buf []byte) []byte {
	buf = marshalUint32(buf, (m.RequestId))
	buf = marshalByte(buf, (m.TargetSystem))
	buf = marshalByte(buf, (m.TargetComponent))
	buf = marshalByte(buf, (m.OsdScreen))
...
func (m *OsdParamShowConfig) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *OsdParamShowConfig) UnmarshalV1(buf []byte) []byte {
...
func (m *OsdParamShowConfig) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type OsdParamShowConfigReply struct {
	/* Request ID - copied from request. */
	RequestId uint32
...
func (m *OsdParamShowConfigReply) ID() int        { return 11036 }
func (m *OsdParamShowConfigReply) CRCExtra() byte { return 177 }

func (m *OsdParamShowConfigReply) MarshalV1(buf []byte) []byte {
	buf = marshalUint32(buf, (m.RequestId))
	buf = marshalFloat32(buf, (m.MinValue))
	buf = marshalFloat32(buf, (m.MaxValue))
	buf = marshalFloat32(buf, (m.Increment))
...
func (m *OsdParamShowConfigReply) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *OsdParamShowConfigReply) UnmarshalV1(buf []byte) []byte {
...
func (m *OsdParamShowConfigReply) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type ObstacleDistance3d struct {
	/* Timestamp (time since system boot). */
	TimeBootMs uint32
...
func (m *ObstacleDistance3d) ID() int        { return 11037 }
func (m *ObstacleDistance3d) CRCExtra() byte { return 130 }

func (m *ObstacleDistance3d) MarshalV1(buf []byte) []byte {
	buf = marshalUint32(buf, (m.TimeBootMs))
	buf = marshalFloat32(buf, (m.X))
	buf = marshalFloat32(buf, (m.Y))
	buf = marshalFloat32(buf, (m.Z))
	buf = marshalFloat32(buf, (m.MinDistance))
	buf = marshalFloat32(buf, (m.MaxDistance))
	buf = marshalUint16(buf, (m.ObstacleId))
	buf = marshalByte(buf, byte(m.SensorType))
	buf = marshalByte(buf, byte(m.Frame))
...
func (m *ObstacleDistance3d) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *ObstacleDistance3d) UnmarshalV1(buf []byte) []byte {
	...
	buf, m.MinDistance = unmarshalFloat32(buf)

	buf, m.MaxDistance = unmarshalFloat32(buf)

	buf, m.ObstacleId = unmarshalUint16(buf)
...
func (m *ObstacleDistance3d) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
func (m *WaterDepth) ID() int        { return 11038 }
func (m *WaterDepth) CRCExtra() byte { return 47 }

func (m *WaterDepth) MarshalV1(buf []byte) []byte {
	buf = marshalUint32(buf, (m.TimeBootMs))
	buf = marshalInt32(buf, (m.Lat))
	buf = marshalInt32(buf, (m.Lng))
	buf = marshalFloat32(buf, (m.Alt))
	...
	buf = marshalFloat32(buf, (m.Temperature))
	buf = marshalByte(buf, (m.Id))
	buf = marshalByte(buf, (m.Healthy))

	return buf
}

func (m *WaterDepth) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *WaterDepth) UnmarshalV1(buf []byte) []byte {
	...
	buf, m.Healthy = unmarshalByte(buf)

	return buf
}

func (m *WaterDepth) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type McuStatus struct {
	...
	/* MCU voltage minimum */
	McuVoltageMin uint16

	/* MCU voltage maximum */
	McuVoltageMax uint16

	/* MCU instance */
	Id byte
}

func (m *McuStatus) ID() int        { return 11039 }
func (m *McuStatus) CRCExtra() byte { return 142 }

func (m *McuStatus) MarshalV1(buf []byte) []byte {
	buf = marshalInt16(buf, (m.McuTemperature))
	buf = marshalUint16(buf, (m.McuVoltage))
	buf = marshalUint16(buf, (m.McuVoltageMin))
	buf = marshalUint16(buf, (m.McuVoltageMax))
	buf = marshalByte(buf, (m.Id))

	return buf
}

func (m *McuStatus) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *McuStatus) UnmarshalV1(buf []byte) []byte {

	buf, m.McuTemperature = unmarshalInt16(buf)

	buf, m.McuVoltage = unmarshalUint16(buf)

	buf, m.McuVoltageMin = unmarshalUint16(buf)

	buf, m.McuVoltageMax = unmarshalUint16(buf)
...
func (m *McuStatus) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type EscTelemetry13To16 struct {
	/* Voltage. */
	Voltage [4]uint16
...
func (m *EscTelemetry13To16) ID() int        { return 11040 }
func (m *EscTelemetry13To16) CRCExtra() byte { return 132 }

func (m *EscTelemetry13To16) MarshalV1(buf []byte) []byte {
	for _, v := range m.Voltage {
		buf = marshalUint16(buf, (v))
	}
	for _, v := range m.Current {
...
func (m *EscTelemetry13To16) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *EscTelemetry13To16) UnmarshalV1(buf []byte) []byte {
...
func (m *EscTelemetry13To16) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type EscTelemetry17To20 struct {
	/* Voltage. */
	Voltage [4]uint16
...
func (m *EscTelemetry17To20) ID() int        { return 11041 }
func (m *EscTelemetry17To20) CRCExtra() byte { return 208 }

func (m *EscTelemetry17To20) MarshalV1(buf []byte) []byte {
	for _, v := range m.Voltage {
		buf = marshalUint16(buf, (v))
	}
	for _, v := range m.Current {
...
func (m *EscTelemetry17To20) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *EscTelemetry17To20) UnmarshalV1(buf []byte) []byte {
...
func (m *EscTelemetry17To20) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type EscTelemetry21To24 struct {
	/* Voltage. */
	Voltage [4]uint16
...
func (m *EscTelemetry21To24) ID() int        { return 11042 }
func (m *EscTelemetry21To24) CRCExtra() byte { return 201 }

func (m *EscTelemetry21To24) MarshalV1(buf []byte) []byte {
	for _, v := range m.Voltage {
		buf = marshalUint16(buf, (v))
	}
	for _, v := range m.Current {
...
func (m *EscTelemetry21To24) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *EscTelemetry21To24) UnmarshalV1(buf []byte) []byte {
...
func (m *EscTelemetry21To24) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type EscTelemetry25To28 struct {
	/* Voltage. */
	Voltage [4]uint16
...
func (m *EscTelemetry25To28) ID() int        { return 11043 }
func (m *EscTelemetry25To28) CRCExtra() byte { return 193 }

func (m *EscTelemetry25To28) MarshalV1(buf []byte) []byte {
	for _, v := range m.Voltage {
		buf = marshalUint16(buf, (v))
	}
	for _, v := range m.Current {
...
func (m *EscTelemetry25To28) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *EscTelemetry25To28) UnmarshalV1(buf []byte) []byte {
...
func (m *EscTelemetry25To28) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type EscTelemetry29To32 struct {
	/* Voltage. */
	Voltage [4]uint16
...
func (m *EscTelemetry29To32) ID() int        { return 11044 }
func (m *EscTelemetry29To32) CRCExtra() byte { return 189 }

func (m *EscTelemetry29To32) MarshalV1(buf []byte) []byte {
	for _, v := range m.Voltage {
		buf = marshalUint16(buf, (v))
	}
	for _, v := range m.Current {
...
func (m *EscTelemetry29To32) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *EscTelemetry29To32) UnmarshalV1(buf []byte) []byte {
...
func (m *EscTelemetry29To32) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
func (m *NamedValueString) ID() int        { return 11060 }
func (m *NamedValueString) CRCExtra() byte { return 162 }

func (m *NamedValueString) MarshalV1(buf []byte) []byte {
	buf = marshalUint32(buf, (m.TimeBootMs))
	for _, v := range m.Name {
		buf = marshalByte(buf, (v))
	}
...
func (m *NamedValueString) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *NamedValueString) UnmarshalV1(buf []byte) []byte {
...
func (m *NamedValueString) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
func (m *TestTypes) ID() int        { return 17000 }
...
func (m *ArrayTest0) ID() int        { return 17150 }
...
func (m *ArrayTest1) ID() int        { return 17151 }
...
func (m *ArrayTest3) ID() int        { return 17153 }
...
func (m *ArrayTest4) ID() int        { return 17154 }
...
func (m *ArrayTest5) ID() int        { return 17155 }
...
func (m *ArrayTest6) ID() int        { return 17156 }
...
func (m *ArrayTest7) ID() int        { return 17157 }
...
func (m *ArrayTest8) ID() int        { return 17158 }
...
/* Raw RC Data */
type CubepilotRawRc struct {
	/*  */
	RcRaw [32]byte
}

func (m *CubepilotRawRc) ID() int        { return 50001 }
func (m *CubepilotRawRc) CRCExtra() byte { return 246 }

func (m *CubepilotRawRc) MarshalV1(buf []byte) []byte {
	for _, v := range m.RcRaw {
		buf = marshalByte(buf, (v))
	}
...
func (m *CubepilotRawRc) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *CubepilotRawRc) UnmarshalV1(buf []byte) []byte {

	for i, _ := range m.RcRaw {
		buf, m.RcRaw[i] = unmarshalByte(buf)
	}

	return buf
}

func (m *CubepilotRawRc) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type HerelinkVideoStreamInformation struct {
	/* Frame rate. */
	Framerate float32
...
func (m *HerelinkVideoStreamInformation) ID() int        { return 50002 }
func (m *HerelinkVideoStreamInformation) CRCExtra() byte { return 181 }

func (m *HerelinkVideoStreamInformation) MarshalV1(buf []byte) []byte {
	buf = marshalFloat32(buf, (m.Framerate))
	buf = marshalUint32(buf, (m.Bitrate))
	buf = marshalUint16(buf, (m.ResolutionH))
	buf = marshalUint16(buf, (m.ResolutionV))
...
func (m *HerelinkVideoStreamInformation) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *HerelinkVideoStreamInformation) UnmarshalV1(buf []byte) []byte {
...
func (m *HerelinkVideoStreamInformation) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
func (m *HerelinkTelem) ID() int        { return 50003 }
func (m *HerelinkTelem) CRCExtra() byte { return 62 }

func (m *HerelinkTelem) MarshalV1(buf []byte) []byte {
	buf = marshalUint32(buf, (m.RfFreq))
	buf = marshalUint32(buf, (m.LinkBw))
	buf = marshalUint32(buf, (m.LinkRate))
	buf = marshalInt16(buf, (m.Snr))
	buf = marshalInt16(buf, (m.CpuTemp))
	buf = marshalInt16(buf, (m.BoardTemp))
	buf = marshalByte(buf, (m.Rssi))

	return buf
}

func (m *HerelinkTelem) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *HerelinkTelem) UnmarshalV1(buf []byte) []byte {

	buf, m.RfFreq = unmarshalUint32(buf)

	buf, m.LinkBw = unmarshalUint32(buf)

	buf, m.LinkRate = unmarshalUint32(buf)

	buf, m.Snr = unmarshalInt16(buf)

	buf, m.CpuTemp = unmarshalInt16(buf)

	buf, m.BoardTemp = unmarshalInt16(buf)
...
func (m *HerelinkTelem) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type CubepilotFirmwareUpdateStart struct {
	/* FW Size. */
	Size uint32
...
func (m *CubepilotFirmwareUpdateStart) ID() int        { return 50004 }
func (m *CubepilotFirmwareUpdateStart) CRCExtra() byte { return 240 }

func (m *CubepilotFirmwareUpdateStart) MarshalV1(buf []byte) []byte {
	buf = marshalUint32(buf, (m.Size))
	buf = marshalUint32(buf, (m.Crc))
	buf = marshalByte(buf, (m.TargetSystem))
	buf = marshalByte(buf, (m.TargetComponent))
...
func (m *CubepilotFirmwareUpdateStart) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *CubepilotFirmwareUpdateStart) UnmarshalV1(buf []byte) []byte {

	buf, m.Size = unmarshalUint32(buf)

	buf, m.Crc = unmarshalUint32(buf)
...
func (m *CubepilotFirmwareUpdateStart) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type CubepilotFirmwareUpdateResp struct {
	/* FW Offset. */
	Offset uint32
...
func (m *CubepilotFirmwareUpdateResp) ID() int        { return 50005 }
func (m *CubepilotFirmwareUpdateResp) CRCExtra() byte { return 152 }

func (m *CubepilotFirmwareUpdateResp) MarshalV1(buf []byte) []byte {
	buf = marshalUint32(buf, (m.Offset))
	buf = marshalByte(buf, (m.TargetSystem))
	buf = marshalByte(buf, (m.TargetComponent))
...
func (m *CubepilotFirmwareUpdateResp) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *CubepilotFirmwareUpdateResp) UnmarshalV1(buf []byte) []byte {

	buf, m.Offset = unmarshalUint32(buf)
...
func (m *CubepilotFirmwareUpdateResp) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
func (m *AirlinkAuth) ID() int        { return 52000 }
func (m *AirlinkAuth) CRCExtra() byte { return 13 }

func (m *AirlinkAuth) MarshalV1(buf []byte) []byte {
	for _, v := range m.Login {
		buf = marshalByte(buf, (v))
	}
	for _, v := range m.Password {
		buf = marshalByte(buf, (v))
...
func (m *AirlinkAuth) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *AirlinkAuth) UnmarshalV1(buf []byte) []byte {

	for i, _ := range m.Login {
		buf, m.Login[i] = unmarshalByte(buf)
	}
...
func (m *AirlinkAuth) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type AirlinkAuthResponse struct {
	/* Response type */
	RespType AirlinkAuthResponseType `mavlink:"byte"`
}

func (m *AirlinkAuthResponse) ID() int        { return 52001 }
func (m *AirlinkAuthResponse) CRCExtra() byte { return 239 }

func (m *AirlinkAuthResponse) MarshalV1(buf []byte) []byte {
	buf = marshalByte(buf, byte(m.RespType))

	return buf
}

func (m *AirlinkAuthResponse) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *AirlinkAuthResponse) UnmarshalV1(buf []byte) []byte {

	{
		var v byte
		buf, v = unmarshalByte(buf)
		m.RespType = AirlinkAuthResponseType(v)
	}

	return buf
}

func (m *AirlinkAuthResponse) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)

	return buf
}

/* Flight director command to the ArduPlane HDGALT mode: set commanded magnetic heading and/or barometric altitude with optional rate caps. Per-axis flags select which fields are applied; unset axes keep their current value. */
type HdgaltCommand struct {
	/* AP-local time (same base as SYSTEM_TIME.time_boot_ms) at which to begin executing. 0 = execute on receipt. A future value queues the command (single slot, replaces any pending one). A past nonzero value executes immediately and is logged as late. */
	StartTimeBootMs uint32

	/* Commanded magnetic heading, 0-360. */
	HeadingDeg float32

	/* Commanded turn rate magnitude during heading capture; AP picks the shortest direction. */
	TurnRateDps float32

	/* Commanded barometric altitude (MSL). */
	AltitudeM float32

	/* Commanded climb-rate cap magnitude during altitude capture; sign derived from the altitude delta. */
	ClimbRateMps float32

	/* Bitmask selecting which axes this command sets. */
	Flags HdgaltCommandFlags `mavlink:"uint16,bitmask"`
}

func (m *HdgaltCommand) ID() int        { return 52100 }
func (m *HdgaltCommand) CRCExtra() byte { return 161 }

func (m *HdgaltCommand) MarshalV1(buf []byte) []byte {
	buf = marshalUint32(buf, (m.StartTimeBootMs))
	buf = marshalFloat32(buf, (m.HeadingDeg))
	buf = marshalFloat32(buf, (m.TurnRateDps))
	buf = marshalFloat32(buf, (m.AltitudeM))
	buf = marshalFloat32(buf, (m.ClimbRateMps))
	buf = marshalUint16(buf, uint16(m.Flags))

	return buf
}

func (m *HdgaltCommand) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *HdgaltCommand) UnmarshalV1(buf []byte) []byte {

	buf, m.StartTimeBootMs = unmarshalUint32(buf)

	buf, m.HeadingDeg = unmarshalFloat32(buf)

	buf, m.TurnRateDps = unmarshalFloat32(buf)

	buf, m.AltitudeM = unmarshalFloat32(buf)

	buf, m.ClimbRateMps = unmarshalFloat32(buf)

	{
		var v uint16
		buf, v = unmarshalUint16(buf)
		m.Flags = HdgaltCommandFlags(v)
	}

	return buf
}

func (m *HdgaltCommand) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)

	return buf
}

/* Periodic state report from the ArduPlane HDGALT mode (1 Hz minimum while engaged), letting the flight director observe commanded versus achieved heading and altitude, capture phase, and warnings. */
type HdgaltState struct {
	/* AP timestamp (time since system boot). */
	TimeBootMs uint32

	/* Start time of the queued future command, or 0 if none queued. */
	QueuedStartTimeMs uint32

	/* Current commanded heading. */
	HeadingTarget float32

	/* Measured magnetic heading. */
	HeadingCurrent float32

	/* Turn rate the FD asked for, or the parameter default. */
	TurnRateCommanded float32

	/* Turn rate the AP is actually achieving. */
	TurnRateActual float32

	/* Current commanded altitude. */
	AltitudeTarget float32

	/* Measured barometric altitude. */
	AltitudeCurrent float32

	/* Commanded climb-rate cap. */
	ClimbRateCommanded float32

	/* Actual vertical speed. */
	ClimbRateActual float32

	/* Current airspeed, for FD situational awareness. */
	AirspeedCurrent float32

	/* Bitmask of which axes are actively controlled. */
	Flags HdgaltStateFlags `mavlink:"uint16,bitmask"`

	/* Warning bits. */
	Warnings HdgaltWarning `mavlink:"uint16,bitmask"`

	/* Capture/hold phase. */
	CaptureState HdgaltCaptureState `mavlink:"byte"`
}

func (m *HdgaltState) ID() int        { return 52101 }
func (m *HdgaltState) CRCExtra() byte { return 220 }

func (m *HdgaltState) MarshalV1(buf []byte) []byte {
	buf = marshalUint32(buf, (m.TimeBootMs))
	buf = marshalUint32(buf, (m.QueuedStartTimeMs))
	buf = marshalFloat32(buf, (m.HeadingTarget))
	buf = marshalFloat32(buf, (m.HeadingCurrent))
	buf = marshalFloat32(buf, (m.TurnRateCommanded))
	buf = marshalFloat32(buf, (m.TurnRateActual))
	buf = marshalFloat32(buf, (m.AltitudeTarget))
	buf = marshalFloat32(buf, (m.AltitudeCurrent))
	buf = marshalFloat32(buf, (m.ClimbRateCommanded))
	buf = marshalFloat32(buf, (m.ClimbRateActual))
	buf = marshalFloat32(buf, (m.AirspeedCurrent))
	buf = marshalUint16(buf, uint16(m.Flags))
	buf = marshalUint16(buf, uint16(m.Warnings))
	buf = marshalByte(buf, byte(m.CaptureState))

	return buf
}

func (m *HdgaltState) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *HdgaltState) UnmarshalV1(buf []byte) []byte {

	buf, m.TimeBootMs = unmarshalUint32(buf)

	buf, m.QueuedStartTimeMs = unmarshalUint32(buf)

	buf, m.HeadingTarget = unmarshalFloat32(buf)

	buf, m.HeadingCurrent = unmarshalFloat32(buf)

	buf, m.TurnRateCommanded = unmarshalFloat32(buf)

	buf, m.TurnRateActual = unmarshalFloat32(buf)

	buf, m.AltitudeTarget = unmarshalFloat32(buf)

	buf, m.AltitudeCurrent = unmarshalFloat32(buf)

	buf, m.ClimbRateCommanded = unmarshalFloat32(buf)

	buf, m.ClimbRateActual = unmarshalFloat32(buf)

	buf, m.AirspeedCurrent = unmarshalFloat32(buf)

	{
		var v uint16
		buf, v = unmarshalUint16(buf)
		m.Flags = HdgaltStateFlags(v)
	}

	{
		var v uint16
		buf, v = unmarshalUint16(buf)
		m.Warnings = HdgaltWarning(v)
	}

	{
		var v byte
		buf, v = unmarshalByte(buf)
		m.CaptureState = HdgaltCaptureState(v)
	}

	return buf
}

func (m *HdgaltState) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type AutopilotStateForGimbalDeviceExt struct {
	/* Timestamp (time since system boot). */
	TimeBootUs uint64
...
func (m *AutopilotStateForGimbalDeviceExt) ID() int        { return 60000 }
func (m *AutopilotStateForGimbalDeviceExt) CRCExtra() byte { return 4 }

func (m *AutopilotStateForGimbalDeviceExt) MarshalV1(buf []byte) []byte {
	buf = marshalUint64(buf, (m.TimeBootUs))
	buf = marshalFloat32(buf, (m.WindX))
	buf = marshalFloat32(buf, (m.WindY))
	buf = marshalFloat32(buf, (m.WindCorrectionAngle))
	buf = marshalByte(buf, (m.TargetSystem))
	buf = marshalByte(buf, (m.TargetComponent))
...
func (m *AutopilotStateForGimbalDeviceExt) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *AutopilotStateForGimbalDeviceExt) UnmarshalV1(buf []byte) []byte {
	...
	buf, m.WindCorrectionAngle = unmarshalFloat32(buf)
...
func (m *AutopilotStateForGimbalDeviceExt) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type Storm32GimbalManagerInformation struct {
	...
	DeviceCapFlags GimbalDeviceCapFlags `mavlink:"uint32,bitmask"`

	/* Gimbal manager capability flags. */
	ManagerCapFlags MavStorm32GimbalManagerCapFlags `mavlink:"uint32,bitmask"`
...
func (m *Storm32GimbalManagerInformation) ID() int        { return 60010 }
func (m *Storm32GimbalManagerInformation) CRCExtra() byte { return 208 }

func (m *Storm32GimbalManagerInformation) MarshalV1(buf []byte) []byte {
	buf = marshalUint32(buf, uint32(m.DeviceCapFlags))
	buf = marshalUint32(buf, uint32(m.ManagerCapFlags))
	buf = marshalFloat32(buf, (m.RollMin))
	buf = marshalFloat32(buf, (m.RollMax))
	buf = marshalFloat32(buf, (m.PitchMin))
	buf = marshalFloat32(buf, (m.PitchMax))
	buf = marshalFloat32(buf, (m.YawMin))
	buf = marshalFloat32(buf, (m.YawMax))
	buf = marshalByte(buf, (m.GimbalId))

	return buf
}

func (m *Storm32GimbalManagerInformation) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *Storm32GimbalManagerInformation) UnmarshalV1(buf []byte) []byte {

	{
		var v uint32
		buf, v = unmarshalUint32(buf)
		m.DeviceCapFlags = GimbalDeviceCapFlags(v)
	}

	{
		var v uint32
		buf, v = unmarshalUint32(buf)
		m.ManagerCapFlags = MavStorm32GimbalManagerCapFlags(v)
	}
	...
	buf, m.GimbalId = unmarshalByte(buf)

	return buf
}

func (m *Storm32GimbalManagerInformation) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type Storm32GimbalManagerStatus struct {
	/* Gimbal device flags currently applied. Same flags as reported by GIMBAL_DEVICE_ATTITUDE_STATUS. */
	DeviceFlags GimbalDeviceFlags `mavlink:"uint16,bitmask"`

	/* Gimbal manager flags currently applied. */
	ManagerFlags MavStorm32GimbalManagerFlags `mavlink:"uint16,bitmask"`

	/* Gimbal ID (component ID or 1-6 for non-MAVLink gimbal) that this gimbal manager is responsible for. */
	GimbalId byte

	/* Client who is currently supervisor (0 = none). */
	Supervisor MavStorm32GimbalManagerClient `mavlink:"byte"`

	/* Profile currently applied (0 = default). */
	Profile MavStorm32GimbalManagerProfile `mavlink:"byte"`
}

func (m *Storm32GimbalManagerStatus) ID() int        { return 60011 }
func (m *Storm32GimbalManagerStatus) CRCExtra() byte { return 183 }

func (m *Storm32GimbalManagerStatus) MarshalV1(buf []byte) []byte {
	buf = marshalUint16(buf, uint16(m.DeviceFlags))
	buf = marshalUint16(buf, uint16(m.ManagerFlags))
	buf = marshalByte(buf, (m.GimbalId))
	buf = marshalByte(buf, byte(m.Supervisor))
	buf = marshalByte(buf, byte(m.Profile))

	return buf
}

func (m *Storm32GimbalManagerStatus) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *Storm32GimbalManagerStatus) UnmarshalV1(buf []byte) []byte {

	{
		var v uint16
		buf, v = unmarshalUint16(buf)
		m.DeviceFlags = GimbalDeviceFlags(v)
	}

	{
		var v uint16
		buf, v = unmarshalUint16(buf)
		m.ManagerFlags = MavStorm32GimbalManagerFlags(v)
	}
...

	{
		var v byte
		buf, v = unmarshalByte(buf)
		m.Supervisor = MavStorm32GimbalManagerClient(v)
	}

	{
		var v byte
		buf, v = unmarshalByte(buf)
		m.Profile = MavStorm32GimbalManagerProfile(v)
	}

	return buf
}

func (m *Storm32GimbalManagerStatus) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type Storm32GimbalManagerControl struct {
	...
	Client MavStorm32GimbalManagerClient `mavlink:"byte"`
}

func (m *Storm32GimbalManagerControl) ID() int        { return 60012 }
func (m *Storm32GimbalManagerControl) CRCExtra() byte { return 99 }

func (m *Storm32GimbalManagerControl) MarshalV1(buf []byte) []byte {
	for _, v := range m.Q {
		buf = marshalFloat32(buf, (v))
	}
	buf = marshalFloat32(buf, (m.AngularVelocityX))
	...
	buf = marshalByte(buf, (m.TargetComponent))
	buf = marshalByte(buf, (m.GimbalId))
	buf = marshalByte(buf, byte(m.Client))

	return buf
}

func (m *Storm32GimbalManagerControl) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *Storm32GimbalManagerControl) UnmarshalV1(buf []byte) []byte {
...

	{
		var v byte
		buf, v = unmarshalByte(buf)
		m.Client = MavStorm32GimbalManagerClient(v)
	}

	return buf
}

func (m *Storm32GimbalManagerControl) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type Storm32GimbalManagerControlPitchyaw struct {
...
func (m *Storm32GimbalManagerControlPitchyaw) ID() int        { return 60013 }
func (m *Storm32GimbalManagerControlPitchyaw) CRCExtra() byte { return 129 }

func (m *Storm32GimbalManagerControlPitchyaw) MarshalV1(buf []byte) []byte {
	buf = marshalFloat32(buf, (m.Pitch))
	buf = marshalFloat32(buf, (m.Yaw))
	buf = marshalFloat32(buf, (m.PitchRate))
	buf = marshalFloat32(buf, (m.YawRate))
...
func (m *Storm32GimbalManagerControlPitchyaw) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *Storm32GimbalManagerControlPitchyaw) UnmarshalV1(buf []byte) []byte {
...
func (m *Storm32GimbalManagerControlPitchyaw) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type Storm32GimbalManagerCorrectRoll struct {
...
func (m *Storm32GimbalManagerCorrectRoll) ID() int        { return 60014 }
func (m *Storm32GimbalManagerCorrectRoll) CRCExtra() byte { return 134 }

func (m *Storm32GimbalManagerCorrectRoll) MarshalV1(buf []byte) []byte {
	buf = marshalFloat32(buf, (m.Roll))
	buf = marshalByte(buf, (m.TargetSystem))
	buf = marshalByte(buf, (m.TargetComponent))
	buf = marshalByte(buf, (m.GimbalId))
...
func (m *Storm32GimbalManagerCorrectRoll) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *Storm32GimbalManagerCorrectRoll) UnmarshalV1(buf []byte) []byte {
...
func (m *Storm32GimbalManagerCorrectRoll) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type QshotStatus struct {
	/* Current shot mode. */
	Mode MavQshotMode `mavlink:"uint16"`

	/* Current state in the shot. States are specific to the selected shot mode. */
	ShotState uint16
}

func (m *QshotStatus) ID() int        { return 60020 }
func (m *QshotStatus) CRCExtra() byte { return 202 }

func (m *QshotStatus) MarshalV1(buf []byte) []byte {
	buf = marshalUint16(buf, uint16(m.Mode))
	buf = marshalUint16(buf, (m.ShotState))

	return buf
}

func (m *QshotStatus) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *QshotStatus) UnmarshalV1(buf []byte) []byte {

	{
		var v uint16
		buf, v = unmarshalUint16(buf)
		m.Mode = MavQshotMode(v)
	}

	buf, m.ShotState = unmarshalUint16(buf)

	return buf
}

func (m *QshotStatus) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type FrskyPassthroughArray struct {
	/* Timestamp (time since system boot). */
	TimeBootMs uint32
...
func (m *FrskyPassthroughArray) ID() int        { return 60040 }
func (m *FrskyPassthroughArray) CRCExtra() byte { return 156 }

func (m *FrskyPassthroughArray) MarshalV1(buf []byte) []byte {
	buf = marshalUint32(buf, (m.TimeBootMs))
	buf = marshalByte(buf, (m.Count))
	for _, v := range m.PacketBuf {
		buf = marshalByte(buf, (v))
	}
...
func (m *FrskyPassthroughArray) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *FrskyPassthroughArray) UnmarshalV1(buf []byte) []byte {

	buf, m.TimeBootMs = unmarshalUint32(buf)

	buf, m.Count = unmarshalByte(buf)

	for i, _ := range m.PacketBuf {
		buf, m.PacketBuf[i] = unmarshalByte(buf)
	}

	return buf
}

func (m *FrskyPassthroughArray) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
func (m *ParamValueArray) ID() int        { return 60041 }
func (m *ParamValueArray) CRCExtra() byte { return 191 }

func (m *ParamValueArray) MarshalV1(buf []byte) []byte {
	buf = marshalUint16(buf, (m.ParamCount))
	buf = marshalUint16(buf, (m.ParamIndexFirst))
	buf = marshalUint16(buf, (m.Flags))
	buf = marshalByte(buf, (m.ParamArrayLen))
	for _, v := range m.PacketBuf {
		buf = marshalByte(buf, (v))
	}
...
func (m *ParamValueArray) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *ParamValueArray) UnmarshalV1(buf []byte) []byte {

	buf, m.ParamCount = unmarshalUint16(buf)

	buf, m.ParamIndexFirst = unmarshalUint16(buf)

	buf, m.Flags = unmarshalUint16(buf)

	buf, m.ParamArrayLen = unmarshalByte(buf)
...
func (m *ParamValueArray) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type MlrsRadioLinkStats struct {
	/* Radio link statistics flags. */
	Flags MlrsRadioLinkStatsFlags `mavlink:"uint16,bitmask"`
	...
	Frequency1 float32 /*EXTENSION*/

	/* Frequency on antenna2 in Hz. 0: unknown. */
	Frequency2 float32 /*EXTENSION*/

}

func (m *MlrsRadioLinkStats) ID() int        { return 60045 }
func (m *MlrsRadioLinkStats) CRCExtra() byte { return 14 }

func (m *MlrsRadioLinkStats) MarshalV1(buf []byte) []byte {
	buf = marshalUint16(buf, uint16(m.Flags))
	buf = marshalByte(buf, (m.TargetSystem))
	buf = marshalByte(buf, (m.TargetComponent))
	buf = marshalByte(buf, (m.RxLqRc))
	buf = marshalByte(buf, (m.RxLqSer))
	buf = marshalByte(buf, (m.RxRssi1))
	buf = marshalInt8(buf, (m.RxSnr1))
	buf = marshalByte(buf, (m.TxLqSer))
	buf = marshalByte(buf, (m.TxRssi1))
	buf = marshalInt8(buf, (m.TxSnr1))
	buf = marshalByte(buf, (m.RxRssi2))
	buf = marshalInt8(buf, (m.RxSnr2))
	buf = marshalByte(buf, (m.TxRssi2))
	buf = marshalInt8(buf, (m.TxSnr2))

	return buf
}

func (m *MlrsRadioLinkStats) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)
	buf = marshalFloat32(buf, (m.Frequency1))
	buf = marshalFloat32(buf, (m.Frequency2))

	return buf
}

func (m *MlrsRadioLinkStats) UnmarshalV1(buf []byte) []byte {

	{
		var v uint16
		buf, v = unmarshalUint16(buf)
		m.Flags = MlrsRadioLinkStatsFlags(v)
	}
	...
	buf, m.RxLqRc = unmarshalByte(buf)

	buf, m.RxLqSer = unmarshalByte(buf)

	buf, m.RxRssi1 = unmarshalByte(buf)

	buf, m.RxSnr1 = unmarshalInt8(buf)

	buf, m.TxLqSer = unmarshalByte(buf)

	buf, m.TxRssi1 = unmarshalByte(buf)

	buf, m.TxSnr1 = unmarshalInt8(buf)

	buf, m.RxRssi2 = unmarshalByte(buf)

	buf, m.RxSnr2 = unmarshalInt8(buf)

	buf, m.TxRssi2 = unmarshalByte(buf)

	buf, m.TxSnr2 = unmarshalInt8(buf)

	return buf
}

func (m *MlrsRadioLinkStats) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
	buf, m.Frequency1 = unmarshalFloat32(buf)
	buf, m.Frequency2 = unmarshalFloat32(buf)
...
type MlrsRadioLinkInformation struct {
	...
	Type MlrsRadioLinkType `mavlink:"byte"`
	...
	TxReceiveSensitivity byte

	/* Receive sensitivity of Rx in inverted dBm. 1..255 represents -1..-255 dBm, 0: unknown. */
	RxReceiveSensitivity byte
}

func (m *MlrsRadioLinkInformation) ID() int        { return 60046 }
func (m *MlrsRadioLinkInformation) CRCExtra() byte { return 171 }

func (m *MlrsRadioLinkInformation) MarshalV1(buf []byte) []byte {
	buf = marshalUint16(buf, (m.TxFrameRate))
	buf = marshalUint16(buf, (m.RxFrameRate))
	buf = marshalUint16(buf, (m.TxSerDataRate))
	buf = marshalUint16(buf, (m.RxSerDataRate))
	buf = marshalByte(buf, (m.TargetSystem))
	buf = marshalByte(buf, (m.TargetComponent))
	buf = marshalByte(buf, byte(m.Type))
	buf = marshalByte(buf, (m.Mode))
	buf = marshalInt8(buf, (m.TxPower))
	buf = marshalInt8(buf, (m.RxPower))
	for _, v := range m.ModeStr {
		buf = marshalByte(buf, (v))
	}
	for _, v := range m.BandStr {
		buf = marshalByte(buf, (v))
	}
	buf = marshalByte(buf, (m.TxReceiveSensitivity))
	buf = marshalByte(buf, (m.RxReceiveSensitivity))

	return buf
}

func (m *MlrsRadioLinkInformation) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *MlrsRadioLinkInformation) UnmarshalV1(buf []byte) []byte {

	buf, m.TxFrameRate = unmarshalUint16(buf)

	buf, m.RxFrameRate = unmarshalUint16(buf)

	buf, m.TxSerDataRate = unmarshalUint16(buf)

	buf, m.RxSerDataRate = unmarshalUint16(buf)
...

	{
		var v byte
		buf, v = unmarshalByte(buf)
		m.Type = MlrsRadioLinkType(v)
	}

	buf, m.Mode = unmarshalByte(buf)

	buf, m.TxPower = unmarshalInt8(buf)

	buf, m.RxPower = unmarshalInt8(buf)

	for i, _ := range m.ModeStr {
		buf, m.ModeStr[i] = unmarshalByte(buf)
	}

	for i, _ := range m.BandStr {
		buf, m.BandStr[i] = unmarshalByte(buf)
	}

	buf, m.TxReceiveSensitivity = unmarshalByte(buf)

	buf, m.RxReceiveSensitivity = unmarshalByte(buf)

	return buf
}

func (m *MlrsRadioLinkInformation) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type MlrsRadioLinkFlowControl struct {
	...
	TxUsedSerBandwidth byte

	/* Receive bandwidth consumption. Values: 0..100, UINT8_MAX: invalid/unknown. */
	RxUsedSerBandwidth byte

	/* For compatibility with legacy method. UINT8_MAX: unknown. */
	Txbuf byte
}

func (m *MlrsRadioLinkFlowControl) ID() int        { return 60047 }
func (m *MlrsRadioLinkFlowControl) CRCExtra() byte { return 55 }

func (m *MlrsRadioLinkFlowControl) MarshalV1(buf []byte) []byte {
	buf = marshalUint16(buf, (m.TxSerRate))
	buf = marshalUint16(buf, (m.RxSerRate))
	buf = marshalByte(buf, (m.TxUsedSerBandwidth))
	buf = marshalByte(buf, (m.RxUsedSerBandwidth))
	buf = marshalByte(buf, (m.Txbuf))

	return buf
}

func (m *MlrsRadioLinkFlowControl) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *MlrsRadioLinkFlowControl) UnmarshalV1(buf []byte) []byte {

	buf, m.TxSerRate = unmarshalUint16(buf)

	buf, m.RxSerRate = unmarshalUint16(buf)

	buf, m.TxUsedSerBandwidth = unmarshalByte(buf)

	buf, m.RxUsedSerBandwidth = unmarshalByte(buf)
...
func (m *MlrsRadioLinkFlowControl) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
func (m *AvssPrsSysStatus) ID() int        { return 60050 }
func (m *AvssPrsSysStatus) CRCExtra() byte { return 220 }

func (m *AvssPrsSysStatus) MarshalV1(buf []byte) []byte {
	buf = marshalUint32(buf, (m.TimeBootMs))
	buf = marshalUint32(buf, (m.ErrorStatus))
	buf = marshalUint32(buf, (m.BatteryStatus))
	buf = marshalByte(buf, (m.ArmStatus))
	buf = marshalByte(buf, (m.ChargeStatus))

	return buf
}

func (m *AvssPrsSysStatus) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *AvssPrsSysStatus) UnmarshalV1(buf []byte) []byte {

	buf, m.TimeBootMs = unmarshalUint32(buf)

	buf, m.ErrorStatus = unmarshalUint32(buf)

	buf, m.BatteryStatus = unmarshalUint32(buf)

	buf, m.ArmStatus = unmarshalByte(buf)

	buf, m.ChargeStatus = unmarshalByte(buf)

	return buf
}

func (m *AvssPrsSysStatus) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
func (m *AvssDronePosition) ID() int        { return 60051 }
func (m *AvssDronePosition) CRCExtra() byte { return 245 }

func (m *AvssDronePosition) MarshalV1(buf []byte) []byte {
	buf = marshalUint32(buf, (m.TimeBootMs))
	buf = marshalInt32(buf, (m.Lat))
	buf = marshalInt32(buf, (m.Lon))
	buf = marshalInt32(buf, (m.Alt))
	buf = marshalFloat32(buf, (m.GroundAlt))
	buf = marshalFloat32(buf, (m.BarometerAlt))

	return buf
}

func (m *AvssDronePosition) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *AvssDronePosition) UnmarshalV1(buf []byte) []byte {
	...
	buf, m.GroundAlt = unmarshalFloat32(buf)

	buf, m.BarometerAlt = unmarshalFloat32(buf)

	return buf
}

func (m *AvssDronePosition) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
func (m *AvssDroneImu) ID() int        { return 60052 }
func (m *AvssDroneImu) CRCExtra() byte { return 101 }

func (m *AvssDroneImu) MarshalV1(buf []byte) []byte {
	buf = marshalUint32(buf, (m.TimeBootMs))
	buf = marshalFloat32(buf, (m.Q1))
	buf = marshalFloat32(buf, (m.Q2))
	buf = marshalFloat32(buf, (m.Q3))
...
func (m *AvssDroneImu) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *AvssDroneImu) UnmarshalV1(buf []byte) []byte {
...
func (m *AvssDroneImu) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
...
type AvssDroneOperationMode struct {
	/* Timestamp (time since FC boot). */
	TimeBootMs uint32

	/* DJI M300 operation mode */
	M300OperationMode byte

	/* horsefly operation mode */
	HorseflyOperationMode byte
}

func (m *AvssDroneOperationMode) ID() int        { return 60053 }
func (m *AvssDroneOperationMode) CRCExtra() byte { return 45 }

func (m *AvssDroneOperationMode) MarshalV1(buf []byte) []byte {
	buf = marshalUint32(buf, (m.TimeBootMs))
	buf = marshalByte(buf, (m.M300OperationMode))
	buf = marshalByte(buf, (m.HorseflyOperationMode))

	return buf
}

func (m *AvssDroneOperationMode) MarshalV2(buf []byte) []byte {
	buf = m.MarshalV1(buf)

	return buf
}

func (m *AvssDroneOperationMode) UnmarshalV1(buf []byte) []byte {

	buf, m.TimeBootMs = unmarshalUint32(buf)

	buf, m.M300OperationMode = unmarshalByte(buf)

	buf, m.HorseflyOperationMode = unmarshalByte(buf)

	return buf
}

func (m *AvssDroneOperationMode) UnmarshalV2(buf []byte) []byte {
	buf = m.UnmarshalV1(buf)
